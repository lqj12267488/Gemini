 ...
 *
 * @author ZhangHao
 * @version 1.0 Date:2018年6月28日
 */
public class DesUtil {

    // 密钥，是加密解密的凭据，长度为8的倍数
    private static final String PASSWORD_CRYPT_KEY = "goisan00";
    ...
    public static void main(String[] args) {
        String basestr = "goisan_0531_2019-11-01";
        String str1 = encrypt(basestr);

        System.out.println("原始值: " + basestr);
        System.out.println("加密后: " + str1);
        System.out.println("解密后: " + decrypt("54E302C4782985DE6008C1E81E35F57D2931D6D76350C65E"));
