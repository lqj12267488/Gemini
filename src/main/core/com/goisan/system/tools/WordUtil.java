...
public class WordUtil {
	...
	public String replaceRTF(String content,Map<String,String> replacecontent){
		...
		for(String key : replacecontent.keySet()){
			rc = strToRtf(replacecontent.get(key) );
			//key = strToRtf(replacecontent.get(key) );
...
//		}
	...
	public void rgModel(String username, Map<String,String> content) {
	...
	nowtime += sdf.format(current).substring(8,10) + "日";*/
		...
		targetcontent = replaceRTF(sourcecontent, content );
...
//		}	
	...
	public static void main(String[] args) {
		...
		content.put("$age$", "32");
		content.put("$sex$", "男");
		content.put("$unitaddress$", "辽宁省大连市中山区长江街206号");
		content.put("$degree$", "本科");
