...
//            hssfRow2.getCell(3).setCellStyle(cellStyle);
            hssfRow2.createCell(3).setCellValue("身份证号");
            hssfRow2.getCell(3).setCellStyle(cellStyle);
            hssfRow2.createCell(4).setCellValue("政治面貌");
            hssfRow2.getCell(4).setCellStyle(cellStyle);
            hssfRow2.createCell(5).setCellValue("民族");
            hssfRow2.getCell(5).setCellStyle(cellStyle);
            hssfRow2.createCell(6).setCellValue("专业代码");
            hssfRow2.getCell(6).setCellStyle(cellStyle);
            hssfRow2.createCell(7).setCellValue("专业名称");
            hssfRow2.getCell(7).setCellStyle(cellStyle);
            hssfRow2.createCell(8).setCellValue("层次");
            hssfRow2.getCell(8).setCellStyle(cellStyle);
            hssfRow2.createCell(9).setCellValue("学制");
            hssfRow2.getCell(9).setCellStyle(cellStyle);
            hssfRow2.createCell(10).setCellValue("学习形式");
            ...
            hssfRow2.createCell(11).setCellValue("班级");
