...
public class Export {
    ...
    private String expertDept,expertWork,expertDate;
    //企业工作时间(年),企业工作本学年（天）,当前专职单位，当前专职职务，专职任职日期
    ...
    public void setRewordTime(String rewordTime) {
    ...
    public String getRewordLevel() {
        return rewordLevel;
    }

    public void setRewordLevel(String rewordLevel) {
