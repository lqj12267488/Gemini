package com.goisan.personnel.training.dao;
...
public interface TrainingDao {
    ...
    //团体培训审核
    List<Training> getGroupAuditList(Training personalTraining);
    //团体培训查询
    List<Training> getGroupSearchList(Training personalTraining);

    //人员树形下拉选
    List<Tree> getEmpTreeByDeptId(@Param("deptId") String deptId,@Param("id") String id);
    //已选人员树形下拉选
