 ...
 */
public interface ArrayClassService {
    //排课计划维护
    ...
    void exportCoursePlan(@Param(value = "arrayClassTeacher") ArrayClassTeacher arrayClassTeacher, @Param(value = "arrayClassClass") ArrayClassClass arrayClassClass,
                          ...
                          ArrayClassCourse arrayClassCourse, ArrayClassCourse arrayClassCoursePublic, ArrayclassResultClass arrayclassResultClass, @Param(value = "arrayclassArray") ArrayclassArray arrayclassArray, String arr_planId, String arrayClassId);
    ...
    void deleteCoursePlan(String arrayClassId);
    ...
    void addArrayClassRoomBatch(ArrayClassRoom arrayClassRoom);
...
// <!--end wq-->
    ...
    * yangshuang
    * */
    List<BaseBean> getSchedule();

    List<BaseBean> getStudentSchedule();
}
