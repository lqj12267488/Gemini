...
public class MajorResponsible extends BaseBean {
    ...
    private String researchResult;//科研成果
    private String researchLeave;//科研成果等级
    private String researchDate;//科研成果获得时间
    private String remark;//合作情况
    private String personType;//人员类型:1专业带头人 2专业负责人 3专业骨干教师
    private String teacherCategory;   //教师性质
    private String teacherNum;   // 学工号
    private String workDept;   //工作单位 名称
    private String guhua;   //区号单位电话
    private String zyWorkdate;   // 专业负责人工作年限
    ...
    public void setTeacherCategoryShow(String teacherCategoryShow) {
        TeacherCategoryShow = teacherCategoryShow;
    }
