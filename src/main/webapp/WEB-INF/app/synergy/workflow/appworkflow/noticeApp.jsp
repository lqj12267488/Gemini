...
<div class="mui-inner-wrap mui-content">
    ...
    <div class="" style="padding-top: 0%">
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <input id="n_type" type="text" style="line-height:40px;height:40px;text-align:center;"
                   class="validate[required,maxSize[20]] form-control"
                   value="${notice.typeShow}" readonly="readonly"/>
        </div>
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <input id="n_content" type="text" style="line-height:40px;height:40px;text-align:center;"
                   class="validate[required,maxSize[20]] form-control"
                   value="${notice.content}" readonly="readonly"/>
        </div>
    </div>
</div>
<style>
