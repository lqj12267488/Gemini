    ...
    <div class="" style="padding-top: 0%">
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <input id="h_requestDate" type="text" style="line-height:40px;height:40px;text-align:center;"
                   class="validate[required,maxSize[20]] form-control"
                   value="${ITDeviceRepai.requestDate}" readonly="readonly"/>
        </div>
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <input id="h_content" type="text" style="line-height:40px;height:40px;text-align:center;"
                   class="validate[required,maxSize[20]] form-control"
                   value="${ITDeviceRepai.reason}" readonly="readonly"/>
        </div>
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <input id="h_remark" type="text" style="text-align:center;"
                   ...
                   value="${ITDeviceRepai.remark}" readonly="readonly"/>
        </div>
    </div>
</div>
<script>
    $(document).ready(function () {
        $("#h_requestDate").val('${ITDeviceRepai.requestDate}'.replace("T"," "));
    })
    function backMain() {
