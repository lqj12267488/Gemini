...
<div class="mui-inner-wrap mui-content">
    ...
    <div class="" style="padding-top: 0%">
            ...
            <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
                <input id="a_remark" style="line-height:40px;height:40px;text-align:center;" type="text" value="${funds.remark}"
                       class="validate[required,maxSize[100]] form-control"
                        readonly="readonly"/>
            </div>
        <div class="col-md-3 tar" style="background:#d0d0d0;height:25px;vertical-align:middle; ">
       ...
       <script type="text/javascript" charset="utf-8">
           function fundsList(businessId) {
                   window.top.location.href = "<%=request.getContextPath()%>/funds2/fundsListResult?id="+businessId +"&type="+'1';
           }
           function backMain() {
