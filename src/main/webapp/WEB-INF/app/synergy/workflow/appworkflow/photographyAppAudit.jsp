    ...
    <div class="" style="padding-top: 0%">
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <input id="shootDate" type="text" style="text-align:center;"
                   class="validate[required,maxSize[20]] form-control"
                   value="${photography.shootDate}" readonly="readonly"/>
        </div>
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <input id="shootingMethod" type="text" style="text-align:center;"
                   class="validate[required,maxSize[20]] form-control"
                   value="${photography.shootingMethod}" readonly="readonly"/>
        </div>
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <input id="machineNumber" type="text" style="text-align:center;"
                   class="validate[required,maxSize[20]] form-control"
                   value="${photography.machineNumber}" readonly="readonly"/>
        </div>
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <input id="content" type="text" style="text-align:center;"
                   class="validate[required,maxSize[20]] form-control"
                   value="${photography.content}" readonly="readonly"/>
        </div>
    </div>
</div>
<script>
    $(document).ready(function () {
        ...
        $("#shootDate").val('${photography.shootDate}'.replace("T"," "));
    })
    function backMain() {
