...
<head>
    ...
    <script src="<%=request.getContextPath()%>/libs/js/app/mui.zoom.js"></script>
<body><%-- onload="onl();"--%>
<!-- 主页面容器 -->
            ...
            if (data.length == 0) {
                ...
                $.each(data, function (key, map) {
                    ...
                    doc = '<div class="mui-input-row mui-checkbox mui-left"> ' +
                        ...
                        '<input name="checkbox" disabled="disabled" type="checkbox" value="' + map.id + '" ' + checkvalue + ' class="rdss"/>' +
                        '</div>';
                    $("#select").append(doc);
                })
            }
