...
<div class="mui-inner-wrap mui-content">
    ...
    <!--style="padding-top: 0%"-->
        <div class="" style="padding-top: 0%">
            ...
            <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
                <div>
                    <input id="distributionChannelsShow" style="line-height:40px;height:40px;text-align:center;"
                           type="text" value="${publicityDelivery.distributionChannelsShow}" readonly="readonly"/>
                </div>
                <div id="menuContent" class="menuContent" style="display: none">
                    <ul id="publicityDeliveryTree" class="ztree"></ul>
                </div>
                <input id="distributionChannels" style="line-height:40px;height:40px;text-align:center;"
                       type="hidden" value="${publicityDelivery.distributionChannels}"/>
            </div>
            <div class="col-md-3 tar" style="background:#d0d0d0;height:25px;vertical-align:middle;">
                &nbsp;&nbsp;&nbsp;&nbsp;申请日期
            </div>
            ...
            <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
                <textarea id="remark" readonly="readonly" style="line-height:40px;height:40px;text-align:center;"
