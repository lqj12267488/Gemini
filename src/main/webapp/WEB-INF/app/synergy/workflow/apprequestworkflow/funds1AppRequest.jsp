...
<div class="mui-inner-wrap mui-content">
    ...
    <div class="" style="padding-top: 0%">
        ...
        <div class="mainBodyClass">
            ...
            <div class="col-md-3 tar" style="background:#d0d0d0;height:35px;vertical-align:middle; ">
...
<script>
    ...
    function save() {
        ...
        $.post("<%=request.getContextPath()%>/funds1/saveFundsAPP", {
            id: $("#e_id").val(),
            amount: $("#e_amount").val(),
            remark: $("#a_remark").val(),
            requestDate: date,
    ...
    function submit() {
        ...
        $.post("<%=request.getContextPath()%>/submit", {
            ...
            function (msg) {
                if (msg.status == 1) {
                    alert(msg.msg);
                    window.location.href = "<%=request.getContextPath()%>/app/workflow/appRequestList?tableName=T_BG_FUNDS1_WF"
                }
            })
    }
