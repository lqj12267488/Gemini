...
<script>
    ...
    function save() {
        ...
        $.post("<%=request.getContextPath()%>/funds/saveFundsAPP", {
            id: $("#e_id").val(),
            amount: $("#e_amount").val(),
            remark: $("#a_remark").val(),
            requestDate: date,
    ...
    function submit() {
        ...
        $.post("<%=request.getContextPath()%>/submit", {
            ...
            function (msg) {
                if (msg.status == 1) {
                    alert(msg.msg);
                    window.location.href = "<%=request.getContextPath()%>/app/workflow/appRequestList?tableName=T_BG_FUNDS_WF"
                }
            })
    }
