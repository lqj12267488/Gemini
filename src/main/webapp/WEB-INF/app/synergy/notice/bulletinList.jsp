...
<header class="mui-bar mui-bar-nav">
    ...
    <h1 id="title" class="mui-title">公告</h1>
...
<script type="text/javascript">
    ...
    function pulldownRefresh() {
        ...
        setTimeout(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<%=request.getContextPath()%>/notice/getBulletinName",
                data:{"page":page},
                async: false,
                dataType: 'json',
            ...
            function createEmlist(jsonStr){
                ...
                $.each(emlistData, function(key, map){
                    ...
                    li.innerHTML = '<div class="mui-table" >'+
                        ...
                        '<a open-type="common"  href="<%=request.getContextPath()%>/notice/listBulletinnmbers?title='+map.title+'&flag='+flag+'&id='+map.id+'" >'
                        +title+'</a>' +
                        '</h3>' +
            ...
            function createEmlist(jsonStr){
                ...
                $.each(emlistData, function(key, map){
                    ...
                    li.innerHTML = '<div class="mui-table" >'+
                        '<div class="mui-table-cell mui-col-xs-10">'+
                                '<h3 class="mui-ellipsis">' +
                                '<a open-type="common"  href="<%=request.getContextPath()%>/notice/bulletinInfo?title=' + title+'&flag='+flag + '&id=' + map.id + '" >'
                                + title + '</a>' +
                                '</h3>' +
