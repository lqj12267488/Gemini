...
<div class="mui-inner-wrap">
    ...
    <header class="mui-bar mui-bar-nav">
        <a class="mui-icon mui-icon-left-nav mui-pull-left" style="color:#fff;" onclick="backNotice()"></a>
    ...
    <div class="mui-content">
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <textarea id="content" type="text" style="text-align:center;"
                   class="validate[required,maxSize[20]] form-control"
        ...
        <div class="col-md-9" style="height:40px;vertical-align:middle;text-align:center;">
            <input id="startTime" type="text" style="text-align:center;"
                   class="validate[required,maxSize[20]] form-control"
                   value="${notice.startTime}" disabled="disabled"/>
        </div>
        <div class="col-md-3 tar" style="background:#d0d0d0;height:25px;vertical-align:middle;">
            &nbsp;&nbsp;&nbsp;&nbsp;结束时间
        </div>
    ...
    <div class="mui-content">
        <div id="bulletinFile" class="form-row">
            <div class="col-md-3 tar" style="background:#d0d0d0;height:25px;vertical-align:middle;">
                &nbsp;&nbsp;&nbsp;&nbsp;附件
            </div>
        </div>
        ...
        <%--<div style="text-align: center">
            ...
            <button class="mui-btn mui-btn-primary" id="noticflag" style="width:80%; display: none; "
                    onclick="yesReadBullet()">标为已读</button>
            </center>
        </div>--%>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        $.post("<%=request.getContextPath()%>/files/getFilesByBusinessId", {
            ...
            if (data.data.length == 0) {
                $("#bulletinFile").append('<div class="col-md-9" style="vertical-align:middle;">'+
    ...
    function backNotice() {
        window.location.href="<%=request.getContextPath()%>/notice/bulletinApp";
    }
