...
<script type="text/javascript">
    ...
    function pulldownRefresh() {
        ...
        setTimeout(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<%=request.getContextPath()%>/notice/getNoticeName",
                data:{"page":page},
                async: false,
                dataType: 'json',
            ...
            function createEmlist(jsonStr){
                ...
                $.each(emlistData, function(key, map){
                    ...
                    li.innerHTML = '<div class="mui-table" >'+
                        ...
                        '<a open-type="common"  href="<%=request.getContextPath()%>/notice/noticeInfo?title='+map.title+'&flag='+flag+'&id='+map.id+'&type='+map.type+'&businessId='+map.businessId+'" >'
                        +title+'</a>' +
                        '</h3>' +
                        '<div style="font-size: 12px;color: #797979">'+"发布日期："+map.publicTime+'</div>'+
                        '</div></div>';
