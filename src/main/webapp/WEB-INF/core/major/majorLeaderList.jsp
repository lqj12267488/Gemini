                ...
                <div class="block block-drop-shadow content">
                    <div class="form-row">
                        ...
                        <a type="button" class="btn btn-default btn-clean"
                           href="<%=request.getContextPath()%>/majorLeader/daochuDate">导出
                        </a>
                        <br>
                    </div>
                    <div class="form-row block" style="overflow-y:auto;">
                        <table id="mltable" cellpadding="0" cellspacing="0"
...
<script>
    ...
    function search() {
        ...
        mltable.ajax.url("<%=request.getContextPath()%>/majorLeader/majorLeaderList?personIdShow="+planName+"&departmentsId="+
