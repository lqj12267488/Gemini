    ...
    <div class="block">
        ...
        <div class="block block-drop-shadow content">
            ...
            <c:forEach items="${className}" var="classObj">
                <header class="mui-bar mui-bar-nav">
                    <h5 class="mui-title">${classObj.text} &nbsp;&nbsp;班级课表</h5>
                </header>
                    ...
                    <table width="100%" border="1" cellspacing="0">
                        ...
                        <c:forEach items="${arrayClassTimeList}" var="arrayClassTime">
                            <tr style="height: 50px">
                                ...
                                <c:forEach items="${weekShow}" var="weekObj">
                                    <td>
                                        <div class="container" id="arrayClass_${classObj.id}_${arrayClassTime.hoursCode}_${weekObj.id}"></div>
                                    </td>
                                </c:forEach>
                            </tr>
                        </c:forEach>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.each(arrayclassResultClassList, function (index, content) {
            var arrayClassName = "arrayClass_"+content.classId+"_" + content.hoursCode+ "_"+ content.week ;
            //单双周
            var weekshow = "";
            /*
    ...
    function back() {
        $("#right").load("<%=request.getContextPath()%>/core/parent/toStudentScheduleList");
    }
