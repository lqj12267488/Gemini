...
<script>
    ...
    $(document).ready(function () {
        tableMessage = $("#tableMessage").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/parent/getParentMessageList',
            },
            "destroy": true,
            "columns": [
                ...
                {"data":"personIdShow","title":"教师","width": "10%"},
                {"data":"readeFlag","title":"教师阅读","width": "10%"},
                {"data":"readeFlagShow","title":"留言阅读","width": "10%"},
                {
                    "width": "10%",
                    "title": "操作",
    ...
    function view(id) {
        $("#right").load("<%=request.getContextPath()%>/parent/toParentMessageView?id=" + id+"&identity=parent");
    }
