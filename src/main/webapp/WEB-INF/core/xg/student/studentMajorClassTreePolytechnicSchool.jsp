...
<script>
    ...
    function zTreeOnClick(event, treeId, treeNode) {
        ...
        $("#studentList").show();
        $("#studentList").load("<%=request.getContextPath()%>/student/studentGridZz", {id: treeNode.id})
    }

    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/student/getMajorClassTreeByLevel?level=2", function (data) {
