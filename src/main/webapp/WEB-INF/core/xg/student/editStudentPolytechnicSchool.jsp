        ...
        <div class="modal-body clearfix">
            ...
            <div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="externalTeachingPoint" name="remark" value="${student.externalTeachingPoint}"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-2 tar">
                    ...
                    <div class="col-md-4">
                        <input id="idCardType" class="js-example-basic-single" value="${student.idCardType}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        姓名拼音
                    </div>
                    <div class="col-md-4">
                        <input id="spellName" name="remark" value="${student.spellName}"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-2 tar">
                    ...
                    <div class="col-md-4">
                        <input id="learnMode" class="js-example-basic-single" value="${student.learnMode}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        入学方式
                    </div>
                    <div class="col-md-4">
                        <input id="enrollmentType" name="remark" value="${student.enrollmentType}"/>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="studyingWay" class="js-example-basic-single" value="${student.studyingWay}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        婚姻状况
                    </div>
                    <div class="col-md-4">
                        <select id="maritalStatus" name="remark"></select>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="trainInterval" class="js-example-basic-single"
                               value="${student.trainInterval}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        是否随迁子女
                    </div>
                    <div class="col-md-4">
                        <input id="trailingChildrenFlag" name="remark" value="${student.trailingChildrenFlag}"/>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="sourcePlaceDivisionCode" class="js-example-basic-single"
                               value="${student.sourcePlaceDivisionCode}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        出生地行政区划码
                    </div>
                    <div class="col-md-4">
                        <input id="birthPlaceDivisionCode" name="remark" value="${student.birthPlaceDivisionCode}"/>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="nativePlaceDivisionCode" class="js-example-basic-single"
                               value="${student.nativePlaceDivisionCode}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        所属派出所
                    </div>
                    <div class="col-md-4">
                        <input id="subordinateStation" name="remark" value="${student.subordinateStation}"/>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="residenceDivisionCode" class="js-example-basic-single"
                               value="${student.residenceDivisionCode}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        学生居住地类型
                    </div>
                    <div class="col-md-4">
                        <input id="studentResidenceType" name="remark" value="${student.studentResidenceType}"/>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="professionalExpertise" class="js-example-basic-single"
                               value="${student.professionalExpertise}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        学制
                    </div>
                    <div class="col-md-4">
                        <select id="eductionalSystem" name="remark"></select>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="healthCondition" class="js-example-basic-single"
                               value="${student.healthCondition}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        招生对象
                    </div>
                    <div class="col-md-4">
                        <input id="enrollmentTarget" name="remark" value="${student.enrollmentTarget}"/>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="cooperationType" name="remark" value="${student.cooperationType}"/>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="examinationCardNumber" class="js-example-basic-single"
                               value="${student.examinationCardNumber}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        考生号
                    </div>
                    <div class="col-md-4">
                        <input id="candidateNumber" name="remark" value="${student.candidateNumber}"/>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="testScores" class="js-example-basic-single" value="${student.testScores}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        联招合作办学形式
                    </div>
                    <div class="col-md-4">
                        <input id="formCooperativeEducation" name="remark" value="${student.formCooperativeEducation}"/>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="codeCooperativeEducation" class="js-example-basic-single"
                               value="${student.codeCooperativeEducation}"></input>
                    </div>
                    <div class="col-md-2 tar">
                        备注
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="subsectionCulture" class="js-example-basic-single"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=XZ", function (data) {
            addOption(data, 'eductionalSystem', '${student.eductionalSystem}');
        });
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=HYZK", function (data) {
            addOption(data, 'maritalStatus', '${student.maritalStatus}');
        });
        //是否在职
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=SF", function (data) {
    ...
    function saveClass() {
        ...
        var studyModelDz = $("#studyModelDz").val();
        var totalPoints = $("#totalPoints").val();
        var idCardType = $("#idCardType").val();
        var spellName = $("#spellName").val();
        var learnMode = $("#learnMode").val();
        var enrollmentType = $("#enrollmentType").val();
        var studyingWay = $("#studyingWay").val();
        var maritalStatus = $("#maritalStatus").val();
        var trainInterval = $("#trainInterval").val();
        var trailingChildrenFlag = $("#trailingChildrenFlag").val();
        var sourcePlaceDivisionCode = $("#sourcePlaceDivisionCode").val();
        var birthPlaceDivisionCode = $("#birthPlaceDivisionCode").val();
        var nativePlaceDivisionCode = $("#nativePlaceDivisionCode").val();
        var subordinateStation = $("#subordinateStation").val();
        var residenceDivisionCode = $("#residenceDivisionCode").val();
        var studentResidenceType = $("#studentResidenceType").val();
        var professionalExpertise = $("#professionalExpertise").val();
        ...
        var externalTeachingPoint = $("#externalTeachingPoint").val();
        ...
        $.post("<%=request.getContextPath()%>/student/savaStudent", {
            ...
            studyModelDz: studyModelDz,
            totalPoints: totalPoints,
            idCardType: idCardType,
            spellName: spellName,
            learnMode: learnMode,
            enrollmentType: enrollmentType,
            studyingWay: studyingWay,
            maritalStatus: maritalStatus,
            trainInterval: trainInterval,
            trailingChildrenFlag: trailingChildrenFlag,
            sourcePlaceDivisionCode: sourcePlaceDivisionCode,
            birthPlaceDivisionCode: birthPlaceDivisionCode,
            nativePlaceDivisionCode: nativePlaceDivisionCode,
            ...
            eductionalSystem: eductionalSystem,
            ...
            subsectionCulture: subsectionCulture,
            externalTeachingPoint: externalTeachingPoint,
