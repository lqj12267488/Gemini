                    ...
                    <div class="form-row">
                        <span id="addbutton">
                            <button type="button" class="btn btn-info btn-clean"
                                    onclick="addStudent()">新增 </button>
                        </span>
                        <a id="expdata" class="btn btn-info btn-clean" onclick="exportStudent()">导出</a>
                        <button class="btn btn-info btn-clean" onclick="showEmpDialog1()">导入</button>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        studentTable.on('click', 'tr a', function () {
            ...
            if (this.id == "updateStudent") {
                $("#dialog").load("<%=request.getContextPath()%>/student/updateStudentZz?studentId=" + studentId);
                $("#dialog").modal("show");
            }
    ...
    function addStudent() {
        var classid = $("#classId").val();
        $("#dialog").load("<%=request.getContextPath()%>/student/addStudentZz?classId=" + classid);
        $("#dialog").modal("show");
    }
    ...
    function showEmpDialog1() {
        $("#dialog").load("<%=request.getContextPath()%>/student/toImportStudent1?classId=" + classId);
        $("#dialog").modal("show");
    }
    ...
    function exportStudent() {
        ...
        var classId = $("#classId").val();
        var hhh = "<%=request.getContextPath()%>/student/exportStudent?type=1&level=2&classId=" + $("#classIdHid").val() + "&name=" + nameSel + "&idcard=" + idcardSel;
