    ...
    <div class="modal-content block-fill-white">
            ...
            <div class="controls">
                <div class="form-row">
                    <div class="col-md-12 tar">
                        <form action='<%=request.getContextPath()%>/student/importStudent?classId=${classId}'
                              id="importStudent" enctype="multipart/form-data"
                              method="post">
        ...
        <div class="modal-footer">
            <a class="btn btn-info btn-clean"
               href="<%=request.getContextPath()%>/student/getStudentExcelTemplate">下载模板</a>
...
<script>
    ...
    function importEmp() {
        ...
        $.ajax({
            url: '<%=request.getContextPath()%>/student/importStudent?classId=' + classId,
            type: "post",
            data: form,
            processData: false,
            contentType: false,
