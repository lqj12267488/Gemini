...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        ...
        <div class="modal-body clearfix">
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="workflowCode" type="text"
                               class="validate[required,maxSize[20]] form-control"/>
                    </div>
                </div>
                <div class="form-row">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-success btn-clean" onclick="saveEmp()">保存</button>
...
<script>
    function saveEmp() {
        ...
        $.post("<%=request.getContextPath()%>/saveWorkflow", {
