...
<div class="modal-dialog">
    ...
    <input id="businessId" hidden value="${id}">
    <input id="talentTrainId" hidden value="${talentTrainId}"/>
...
<script>
    $(document).ready(function () {
        $("#filesTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/files/getFilesById?id=${id}',
            },
            "destroy": true,
            "columns": [
                {
    ...
    function del(id) {
        ...
        swal({
            ...
            $.post("<%=request.getContextPath()%>/files/delTalentFile", {
                id: id,
                talentTrainId:'${talentTrainId}',
