                ...
                <div class="content block-fill-white">
                    <div class="row">
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <input id="name" type="text" value="${emp.name}"
                            ...
                            <div class="col-md-4">
                                <input id="usedName" type="text"  value="${emp.usedName}" />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 tar">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <input id="address" type="text"  value="${emp.address}" />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 tar">
                            ...
                            <div class="col-md-4">
                                <input id="tel" type="text" value="${emp.tel}"/>
                            </div>
                            <div class="col-md-2 tar">
                                国籍
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <input id="staffId" type="text"  value="${emp.staffId} "/>
                            </div>
                            <div class="col-md-2 tar">
                                出生地
                            </div>
                            <div class="col-md-4">
                                <input id="birthPlace" type="text"  value="${emp.birthPlace}" />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 tar">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input  readonly value="${emp.staffStatusShow}"/>
                        ...
                        <div class="form-row">
                            <div class="col-md-11 tar">
                                <button type="button" class="btn btn-success btn-clean" onclick="updateEmp()">保存</button>
                            </div>
                        </div>
                    </div>
                </div>
...
/*
        $.get("/common/getSysDict?name=JZGZT", function (data) {
