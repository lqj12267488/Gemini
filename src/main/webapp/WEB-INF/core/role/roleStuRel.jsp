    ...
    <div class="modal-content block-fill-white">
        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls" id="style-4" style="overflow-y:auto;height:70% ">
                ...
                <ul id="studentTree" class="ztree"></ul>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/student/getStudentTree?roleId="+$("#rel_roleid").val(), function (data) {
            studentTree = $.fn.zTree.init($("#studentTree"), setting, data);
            studentTree.expandAll(true);
        });
    });

    function saveRelation(){
        var roleid = $("#rel_roleid").val();
        var nodes=studentTree.getCheckedNodes(true);
        ...
        showSaveLoading();
        $.post("<%=request.getContextPath()%>/role/saveStuRelation", {
            roleid:roleid,
            checkList:checkList
        }, function (msg) {
            hideSaveLoading();
