        ...
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="block block-drop-shadow content">
                    <div class="form-row">
                        <button type="button" id="print" class="btn btn-info btn-clean" onclick="printDate()">打印</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        listTable = $("#listGrid").DataTable({
            ...
            "columns": [
                ...
                {"width": "7%", "data": "roleState", "title": "授权状态"},
        ...
        expList("", "", "", "", "", "", "", "", "", "");
        // expList(oneLevel,twoLevel,fileType,yearCode,deptName,personName,schoolType,selstate,arcode,arname);
    ...
    function search() {
        ...
        <%--var idcardSel = $("#condition").val();--%>
        listTable.ajax.url("<%=request.getContextPath()%>/archives/getLeaderArchivesList?oneLevel=" + oneLevel + "&twoLevel=" + twoLevel +
            "&fileType=" + fileType + "&schoolType=" + schoolType + "&yearCode=" + yearCode + "&archivesCode=" + arcode +
            "&archivesName=" + arname + "&requestFlag=" + selstate + "&personName=" + personName + "&deptId=" + deptId
            + "&roleState=" + roleState + "&formatTimeStart=" + formatTimeStart + "&formatTimeEnd=" + formatTimeEnd).load();
        expList(oneLevel, twoLevel, fileType, yearCode, deptId, personName, schoolType, selstate, arcode, arname, roleState);
    }

    function expList(oneLevel, twoLevel, fileType, yearCode, deptId, personName, schoolType, selstate, arcode, arname, roleState) {
        var href = "<%=request.getContextPath()%>/archives/expList?oneLevel=" + oneLevel + "&twoLevel=" + twoLevel +
            "&fileType=" + fileType + "&schoolType=" + schoolType + "&yearCode=" + yearCode + "&archivesCode=" + arcode +
            "&archivesName=" + arname + "&requestFlag=" + selstate + "&personName=" + personName + "&deptId=" + deptId + "&roleState=" + roleState;
    ...
    function printDate() {
        ...
        personName = encodeURI(encodeURI(personName));
        arname = encodeURI(encodeURI(arname));
        var print = "<%=request.getContextPath()%>/archives/printArchives?oneLevel=" + oneLevel + "&twoLevel=" + twoLevel +
            "&fileType=" + fileType + "&schoolType=" + schoolType + "&yearCode=" + yearCode + "&archivesCode=" + arcode +
            "&archivesName=" + arname + "&requestFlag=" + selstate + "&personName=" + personName + "&deptId=" + deptId + "&roleState=" + roleState;
        ...
        $.get(print, function (html) {
            ...
            $("#right").load("<%=request.getContextPath()%>/archives/leaderArchivesList");
        })
    }
