...
<script>
    ...
    /*查询函数*/
    function search() {
        listTable.ajax.url("<%=request.getContextPath()%>/archives/getLeaderArchivesList?condition=" + $("#condition").val()).load();
    }

    function expList() {
        var href = "<%=request.getContextPath()%>/archives/expList?condition=" + $("#condition").val();
        $("#expdata").attr("href", href);
    }

    function printDate() {
        var print = "<%=request.getContextPath()%>/archives/printArchives?condition=" + $("#condition").val();
