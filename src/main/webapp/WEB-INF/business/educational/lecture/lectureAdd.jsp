            ...
            <div class="modal-body clearfix">
                <div class="controls">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-9">
                            <select id="fieldType" name="fieldType" class="js-example-basic-single" onchange="changeFieldType()">
                            </select>
                        </div>
                    </div>
                    <div class="form-row">
...
<script>
    ...
    function save() {
        ...
        $.ajax({
            type: "post",
            url: "<%=request.getContextPath()%>/lecture/saveLecture",
