...
<script>
    ...
    function searchTextBookStatistics() {
        ...
        table = $("#textBookGrid").DataTable({
            ...
            "columns": [
                ...
                {"data": "textbookPlanId", "visible": false},
                ...
                {"width": "10%", "data": "college", "title": "所属学院"},
                {"width": "10%", "data": "majorIdShow", "title": "专业名称"},
                {"width": "10%", "data": "classIdShow", "title": "班级"},
                {"width": "10%", "data": "actualNum", "title": "实发数量"},
                {"width": "10%", "data": "receiver", "title": "领取人"},
                ...
                // {"width": "10%", "data": "remark", "title": "备注"},
                {
                    "width": "10%", "title": "操作", "render": function (data, type, row) {
                        return "<a onclick='showDetails(\"" + row.textbookId + "\",\"" + row.textbookPlanId + "\" )' class='icon-search' title='查看申报详情'></a>&nbsp;&nbsp;&nbsp;";
                    }
                }
            ],
            'order': [5, 'desc'],
    ...
    function showDetails(textbookId, textbookPlanId) {
        $("#dialog").load("<%=request.getContextPath()%>/textbook/showTextBookDeclareDetails?textbookId=" + textbookId + "&textbookPlanId=" + textbookPlanId);
        $("#dialog").modal("show");
    }
</script>
