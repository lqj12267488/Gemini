...
<script>
    function importScore() {
        ...
        $.ajax({
            url: '<%=request.getContextPath()%>/scoreMakeup/importMakeupScore1109?type=' + type + '&scoreExamId=' + scoreExamId +
                "&examMethod=" + examMethod + "&classId=" + classId+"&normalType=${normalType}"+"&courseId=${courseId}",
            type: "post",
            data: form,
            processData: false,
            contentType: false,
