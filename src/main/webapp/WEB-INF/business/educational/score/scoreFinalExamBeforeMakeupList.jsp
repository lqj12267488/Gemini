            ...
            <div class="block">
                <div class="block block-drop-shadow">
                    <div class="content block-fill-white">
                        <header class="mui-bar mui-bar-nav">
                            <h5 class="mui-title">${scoreExamName} > 毕业前补考学生名单</h5>
                        </header>
                        <div class="form-row">
                            <div class="form-row">
                                <div class="col-md-10" style="overflow: hidden;  margin-bottom: 10px">
                                    ...
                                    <div class="col-md-2" style="width: 15%;">
                                        <input id="query_studentNumber" type="text"
                                               class="validate[required,maxSize[100]] form-control"/>
                                    </div>
                                    <div class="col-md-2 tar">
                                        身份证号码：
                                ...
                                <div class="col-md-10" style="overflow: hidden; margin-bottom: 10px;">
                                    ...
                                    <div class="col-md-2" style="width: 15%;">
                                        <input id="query_graduationYears" type="text"
                                               class="validate[required,maxSize[100]] form-control"/>
                                    </div>
                                    <div class="col-md-2 tar">
                                        考核方式：
                ...
                <div class="block block-drop-shadow content">
                    <div class="form-row">
                        ...
                        <button type="button" class="btn btn-default btn-clean" onclick="toCheckedClass(3,3)">毕业前补考情况表
                        </button>
                        <button type="button" class="btn btn-default btn-clean" onclick="toCheckedClass(3,4)">
                            毕业前补考不合格情况表
                        </button>
...
<script>
    ...
    function searchClear() {
        ...
        $("#query_examType").val("");
        $("#query_teacherId").val("");
        $("#query_studentNumber").val("");
        $("#query_graduationYears").val("");
        search();
    }
    ...
    function search() {
        ...
        var studentNum = $("#query_studentNumber").val();
        ...
        listTable = $("#listGrid").DataTable({
            ...
            "columns": [
                ...
                {"data": "studentNum", "width": "6%", "title": "学生学号"},
                ...
                {
                    "width": "6%", "title": "毕业前补考成绩", "data": "score",
                    "render": function (data, type, row) {
                        // if (row.submitFlag == '1') {
                        //     return row.score;
                        // }
                ...
                /* {
                     ...
                     "render": function (data, type, row) {
                         ...
                         var html = "<select name='score_" + row.id + "' " + dis + " style='min-width: 65px;'>";
                         $.each(dataSQ, function (index, content) {
                             if (content.text === row.score) {
                                 html += "<option value='" + content.id + "' selected='selected'>" + content.text + "</option>";
                             } else {
                                 html += "<option value='" + content.id + "'>" + content.text + "</option>";
...
//                {
//                    "width": "6%","title": "毕业前补考成绩情况","data": "scoreType",
//                    "render": function (data, type, row) {
//                        var dis = "";
...
//                },
    ...
    //返回
    function back() {
        <%--$("#right").load("<%=request.getContextPath()%>/scoreMakeup/examList?type=3");--%>
