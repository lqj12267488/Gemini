            ...
            <div class="block">
                <div class="block block-drop-shadow">
                    <div class="content block-fill-white">
                        <header class="mui-bar mui-bar-nav">
                            <h5 class="mui-title">${scoreExamName} > 期末补考学生名单</h5>
                        </header>
                        <div class="form-row">
                            <div class="form-row">
                ...
                <div class="block block-drop-shadow content">
                    <div class="form-row">
                        ...
                        <button type="button" class="btn btn-default btn-clean" onclick="toFailCount();">
                            期末补考后挂科数统计表
                        </button>
                        <c:if test="${editFlag == '1' }">
                        ...
                        <c:if test="${flag == 1}">
                            <button type="button" class="btn btn-default btn-clean" onclick="changeOpenFlag()">
                                发布成绩
                            </button>
                        </c:if>
                        <a id="expAlldata" class="btn btn-default btn-clean" onclick="expAlldata()">批量导出</a>
                    </div>
...
<script>
    ...
    var render1 = "<a  class='icon-edit' title='成绩修改申请'>";
    ...
    //批量导出
    function expAlldata() {
        var href = "<%=request.getContextPath()%>/score/exportAllClass?scoreExamId=${scoreExamId}";
        $("#expAlldata").attr("href", href);
    }
    ...
    function toFailCount() {
        window.location.href = "<%=request.getContextPath()%>/scoreMakeup/exportFailCount?examId=${scoreExamId}&classId=${classId}&term=${termId}"
    }
