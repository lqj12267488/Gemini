            ...
            <div class="controls">
                <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-9">
                            <select id="t_examinationStatus"  ></select>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3 tar">
...
<script>
    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=KSZT", function (data) {
            addOption(data, 't_examinationStatus', '${scoreImport.examinationStatus}');
        });
    })

    function save() {
        var reg = new RegExp("^[0-9]*$");
        if ($("#t_examinationStatus").val() == "" ||$("#t_examinationStatus").val() == undefined) {
        ...
        $.post("<%=request.getContextPath()%>/scoreImport/addScoreImportTeacher", {
            id:$("#id").val(),
            examinationStatus:$("#t_examinationStatus").val(),
            score: $("#t_score").val()
