...
<script>
    ...
    $(document).ready(function () {
        ...
        scoreExamTable.on('click', 'tr a', function () {
            ...
            if (this.id == "list") {
                $("#right").load("<%=request.getContextPath()%>/scoreExam/openTeaScoreList?scoreExamId=" + scoreExamId+"&scoreExamName="+scoreExamName);
                $("#right").modal("show");
            }
        });
    })
    ...
    function search() {
        ...
        scoreExamTable = $("#scoreExamGrid").DataTable({
            ...
            "ajax": {
                "type":"post",
                "url": '<%=request.getContextPath()%>/scoreExam/getTeaOpenScoreExamList',
                "data":{
                    term:term
                }
            },
