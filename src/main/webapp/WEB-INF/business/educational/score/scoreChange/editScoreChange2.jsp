        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="f_requestDate" value="${scoreChange.requestDate}" readonly="readonly"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <select id="f_majorCode" disabled="disabled"
                                class="validate[required,maxSize[100]] form-control"/>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <select id="f_classId" disabled="disabled"
                                class="validate[required,maxSize[100]] form-control"/>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <select id="f_studentId" disabled="disabled"
                                class="validate[required,maxSize[100]] form-control"/>
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <select id="f_courseId" disabled="disabled"
                                class="validate[required,maxSize[100]] form-control"/>
                    </div>
                </div>
                <div class="form-row">
...
<script>
    ...
    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=BYQBKCJ", function (data) {
            kszt = data;
            addOption(data, 'f_score', '${scoreChange.makeupScore}');
        });
