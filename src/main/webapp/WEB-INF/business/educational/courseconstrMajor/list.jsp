...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $("#table").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/courseconstr/getListMajor',
            },
            "destroy": true,
            "columns": [
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/courseconstr/toAddMajor", {
    ...
    function edit(id) {
        $("#dialog").load("<%=request.getContextPath()%>/courseconstr/toEditMajor?id=" + id)
        $("#dialog").modal("show")
    }
    ...
    function del(id,courseName) {
        swal({
            ...
            $.post("<%=request.getContextPath()%>/courseconstr/delMajor", {
                id: id
            }, function (msg) {
                swal({
                    title: msg.msg,
    ...
    function search() {
        ...
        var arr = major.split(",");
        var url = "<%=request.getContextPath()%>/courseconstrMajor/getList?courseType=${type}&courseName=" + courseName + "&departmentsId=" + departmentsId +
    ...
    function searchclear() {
        ...
        $("#majorCodeSearch").val("");
        $("#table").DataTable().ajax.url("<%=request.getContextPath()%>/courseconstrMajor/getList?courseType=${type}").load();
    }
