            ...
            <div class="block">
                ...
                <div class="block block-drop-shadow content">
                    <div class="form-row">
                      ...
                      <%--  <button type="button" class="btn btn-default btn-clean" onclick="importCompetitionRequest()">
                            导入
                        </button>--%>
                        <br>
                    </div>
...
<script>
    ...
    function exportGrade() {
        var href = "<%=request.getContextPath()%>/competitionRequest/exportCompetitionRequest";
        $("#expdata").attr("href", href);
    }
    function importCompetitionRequest(){
    ...
    function search() {
        ...
        roleTable = $("#competitionRequest").DataTable({
            ...
            "columns": [
                ...
                {"width": "10%", "data": "organizationUnit", "title": "承办单位"},
                {
                    "width": "10%",
                    "title": "操作",
                    "render": function () {
