        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <select id="toExcel_semester" class="form-control"></select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <div style="white-space:nowrap;">
                            <input id="deptSel" type="text" onclick="showMenu()"
                                   readonly/>
                        </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="toExcel_pBy" type="text" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"
                               class="validate[required,maxSize[50]] form-control"/>
                        <input id="toExcel_preparedBy" type="hidden">
                    </div>
                </div>
            </div>
        </div>
        <div class="modal-footer">
            <button type="button" id="saveBtn" class="btn btn-success btn-clean" onclick="outData()">导出数据</button>
...
<script>
    ...
    function outData() {
        ...
        window.location.href="<%=request.getContextPath()%>/teachingTask/outClassData?deptId="+department+"&userId="+teacherId+"&semester="+semester+"&departmentShow="+$("#deptSel").val()+"&teacherShow="+$("#toExcel_pBy").val().split(" ---- ")[0];
    }
