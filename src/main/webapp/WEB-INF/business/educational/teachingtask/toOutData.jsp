...
<script>
    ...
    function outData() {
        ...
        window.location.href="<%=request.getContextPath()%>/teachingTask/outData?deptId="+department+"&semester="+semester+"&departmentShow="+$("#deptSel").val()+"&teacherShow="+$("#toExcel_pBy").val().split(" ---- ")[0];
    }
