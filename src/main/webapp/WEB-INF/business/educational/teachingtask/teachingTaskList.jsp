                        ...
                        <div class="block block-drop-shadow content">
                            <div>
                                <div class="form-row">
                                    ...
                                    <button type="button" class="btn btn-default btn-clean" onclick="toOutClassData();">班级落课情况导出
                                    </button>
...
<script>
    ...
    function search() {
        ...
        bMTable = $("#bMGrid").DataTable({
            ...
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/teachingTask/getTeachingTaskList',
                "data": {
                    semester : semester,
                    courseId : courseId,
                    teacherId : teacherId,
    ...
    function toOutClassData(){
        $("#dialog").load("<%=request.getContextPath()%>/teachingTask/toOutClassData");
        $("#dialog").modal("show");
    }
