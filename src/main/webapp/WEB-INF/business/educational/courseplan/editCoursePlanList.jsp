    ...
    <div class="modal-content block-fill-white">
        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                ...
                <div class="form-row">
                    <div class="col-md-3 tar">
                        <span class="iconBtx">*</span> 教师
                    </div>
                    <div class="col-md-9">
                        <input id="person" type="text" value="${data.personIdShow}"/>
                        <input id="perId" type="hidden" value="${data.teacherPersonId}"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
...
<script>
    ...
    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=XQ", function (data) {
            addOption(data, 'semester','${data.semester}');
        });
    ...
    function save() {
        ...
        if($("#semester").val() == "" || $("#semester").val() == "0" || $("#semester").val() == undefined){
            swal({
                title: "请选择学期！",
                type: "info"
            });
        ...
        $.post("<%=request.getContextPath()%>/courseplan/save", {
            ...
            teacherPersonId: $("#person").attr("keycode"),
