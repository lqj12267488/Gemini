...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        <div class="modal-header">
            ...
            <input id="id" hidden value="${arrayClassCourse1.arrayClassCourseId}">
        ...
        <div class="modal-body clearfix">
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="a_startWeek" value="${arrayClassCourse1.startWeek}" onchange="changeWeekNumber()">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <input id="a_endWeek" value="${arrayClassCourse1.endWeek}" onchange="changeWeekNumber()">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <input id="a_weekNumber" disabled value="${arrayClassCourse1.weekNumber}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <input id="a_weekHours" value="${arrayClassCourse1.weekHours}" onchange="changeTotleHours()">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <input id="a_totleHours" disabled value="${arrayClassCourse1.totleHours}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                ...
                <div class="form-row" id = "roomType">
                    ...
                    <div class="col-md-9">
                        <div>
                            <input id="roomShow" type="text" onclick="showMenu()"  value="${arrayClassCourse1.roomShow}"/>
                        </div>
                        <div id="menuContent" class="menuContent">
                            <ul id="classTree" class="ztree"></ul>
                        </div>
                        <input id="classRoom" type="hidden" value="${arrayClassCourse1.roomId}"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <input id="a_credit" value="${arrayClassCourse1.credit}">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        $("#roomType").hide();
        if ('${arrayClassCourse1.teachType}' =='1' || '${arrayClassCourse1.teachType}' == ''){
            $("#roomType").hide();
        }else{
            $("#roomType").show();
        }
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=XZLX", function (data) {
            addOption(data, 'a_weekType', '${arrayClassCourse1.weekType}');
        })
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=SKXS", function (data) {
            addOption(data, 'a_teachType', '${arrayClassCourse1.teachType}');
        });
        ...
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=KCLX", function (data) {
            addOption(data, 'a_courseType', '${arrayClassCourse1.courseType}');
        });
        //系部下拉回显
        $.get("<%=request.getContextPath()%>/common/getTableDict", {
            ...
            function (data) {
                addOption(data, "a_departmentsId", '${arrayClassCourse1.departmentsId}');
            })
        //专业下拉回显
        $.get("<%=request.getContextPath()%>/common/getTableDict", {
                id: " code ",
            ...
            function (data) {
                var major = '${arrayClassCourse1.majorCode}' +"," +'${arrayClassCourse1.trainingLevel}';
        ...
        $.get("<%=request.getContextPath()%>/common/getTableDict", {
            ...
            function (data) {
                addOption(data, "a_courseID", '${arrayClassCourse1.courseID}');
            });
        //系部联动专业
