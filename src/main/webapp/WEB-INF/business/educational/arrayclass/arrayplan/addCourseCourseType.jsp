        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="a_credit" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"
                               maxlength="10" placeholder="最多输入10位数字" value="${arrayClassCourse.credit}">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var courseType = '${arrayClassCourse.courseType}';
        if ("1" == courseType) {
            $("#departmentsId").hide();
            $("#majorId").hide();
        } else {
