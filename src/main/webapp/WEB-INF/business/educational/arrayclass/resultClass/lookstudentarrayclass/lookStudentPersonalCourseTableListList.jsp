            ...
            <div class="block">
                ...
                <div class="block block-drop-shadow content">
                    <div class="form-row block" style="overflow-y:auto;">
                        <table id="arrayClassGrid" cellpadding="0"
                               cellspacing="0"
...
<script>
    ...
    $(document).ready(function () {
        ...
        arrayClass.on('click', 'tr a', function () {
            ...
            if (this.id == "editRoom") {
                $("#right").load("<%=request.getContextPath()%>/arrayClassResultClass/selectStudentCourse?arrayclassId=" + arrayClassId+"&arrayClassName="+data.arrayClassName);
            }
        });
    })
        ...
        arrayClass = $("#arrayClassGrid").DataTable({
            ...
            "columns": [
                ...
                {"width": "22%", "data": "remark", "title": "备注"},
                {
                    ...
                    "title": "操作",
                    "render": function () {
                        return "<a id='editRoom' class='icon-th' title='查看个人课表'></a>";
                    }
                }
            ],
            'order' : [[1,'desc'],[2,'desc']],
