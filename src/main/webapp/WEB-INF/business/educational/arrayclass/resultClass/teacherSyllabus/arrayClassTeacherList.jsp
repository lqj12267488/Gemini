...
<script>
    ...
    $(document).ready(function () {
        ...
        arrayClass.on('click', 'tr a', function () {
            ...
            if (this.id == "teacherList") {
                $("#right").load("<%=request.getContextPath()%>/arrayClassResultClass/teacherSyllabusList?arrayClassId=" + arrayClassId+"&arrayClassName="+arrayClassName);
            }
        });
    })
    ...
    function search() {
        var arrayclassId = $("#arrayClassName").val();
        ...
        arrayClass = $("#arrayClassGrid").DataTable({
            ...
            "columns": [
                ...
                {"width": "22%", "data": "remark", "title": "备注"},
                {
                    ...
                    "title": "操作",
                    "render": function () {
                        return "<a id='teacherList' class='icon-th-list' title='查看教师列表'></a>";
                    }
                }
            ],
            'order' : [[1,'desc'],[2,'desc']],
