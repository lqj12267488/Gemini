...
<script>
    ...
    $(document).ready(function () {
        ...
        arrayClass.on('click', 'tr a', function () {
            ...
            if (this.id == "editRoom") {
                $("#right").load("<%=request.getContextPath()%>/arrayClassResultClass/toPlaceList?arrayClassId=" + arrayClassId+"&arrayClassName="+data.arrayClassName);
            }
        });
    })
        ...
        arrayClass = $("#arrayClassGrid").DataTable({
            ...
            "columns": [
                ...
                {"width": "22%", "data": "remark", "title": "备注"},
                {
                    ...
                    "title": "操作",
                    "render": function () {
                        return "<a id='editRoom' class='icon-th-list' title='查看场地列表'></a>";
                    }
                }
            ],
            'order' : [[1,'desc'],[2,'desc']],
