        ...
        <div class="block block-drop-shadow">
            <div class="content block-fill-white">
                <header class="mui-bar mui-bar-nav">
                    <h5 class="mui-title">${arrayClassName} > ${roomId} > 场地课表查看</h5>
...
<script>
    ...
    function back() {
        $("#right").load("<%=request.getContextPath()%>/arrayClassResultClass/toPlaceList?arrayClassId=${arrayClassId}&arrayClassName=${arrayClassName}");
    }
