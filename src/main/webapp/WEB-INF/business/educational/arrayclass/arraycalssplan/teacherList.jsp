...
<script>
            ...
            "columns": [
                ...
                {"width": "22%", "data": "remark", "title": "备注"},
                {
                    ...
                    "render": function (data, type, row) {
                        return '<span class="icon-edit" title="维护教师授课计划" onclick=toArrayClassClassList("' + row.arrayClassId + '","'+row.arrayClassName+'")/>&ensp;&ensp;';
                    }
                }
            ],
            'order': [[1, 'desc'], [2, 'desc']],
    ...
    function toArrayClassClassList(id,arrayClassName) {
        $("#right").load("<%=request.getContextPath()%>/arrayclassplan/toArrayClassTecaherList?id=" + id + "&arrayClassName="+arrayClassName);
