...
<script>
            ...
            "columns": [
                ...
                {"width": "22%", "data": "remark", "title": "备注"},
                {
                    ...
                    "render": function (data, type, row) {
                        return '<span class="icon-edit" title="排课" onclick=schedulingCourse("' + row.arrayClassId + '")/>&ensp;&ensp;';
                    }
                }
            ],
            'order': [[1, 'desc'], [2, 'desc']],
    ...
    function schedulingCourse(id) {
        swal({
            ...
            $.post("<%=request.getContextPath()%>/arrayclassplan/schedulingCourse", {
                arrayclassId: id
            }, function (msg) {
                swal({
                    title: msg.msg,
