    ...
    <div class="modal-content block-fill-white">
        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                ...
                <div class="form-row">
                    <div class="col-md-3 tar">
                        <span class="iconBtx">*</span> 楼层数
                    </div>
                    <div class="col-md-9">
                        <select id="f_floorNumber"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                        <span class="iconBtx">*</span>  房间数
                    </div>
                    <div class="col-md-9">
...
<script>
    ...
    function saveDept() {
        ...
        if ($("#buildingTypeId").val() == "" || $("#buildingTypeId").val() == "0" || $("#buildingTypeId").val() == undefined) {
            swal({
                title: "请选择楼宇类型！",
                type: "info"
            });
        ...
        if ($("#f_floorNumber").val() == "" || $("#f_floorNumber").val() == "0" || $("#f_floorNumber").val() == undefined) {
            swal({
                title: "请选择楼层数！",
                type: "info"
            });
