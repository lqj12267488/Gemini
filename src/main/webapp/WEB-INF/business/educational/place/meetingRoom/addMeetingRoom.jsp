        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="f_meetingRoomName" type="text"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <select id="abuildingId"  class="js-example-basic-single" disabled="disabled"></select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <input id="f_peopleNumber" type="text" readonly="readonly"
                               class="validate[required,maxSize[20]] form-control"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <select id="efloorId"  class="js-example-basic-single" disabled="disabled"></select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
