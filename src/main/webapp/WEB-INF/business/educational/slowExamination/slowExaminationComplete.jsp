...
<script>
        ...
        roleTable.on('click', 'tr a', function () {
            ...
            if (this.id == "uRole") {
                $("#right").load("<%=request.getContextPath()%>/getWotkflowLog", {
                    ...
                    url: "<%=request.getContextPath()%>/slowExamination/auditSlowExaminationById?id=" + id,
                    backUrl: "/slowExamination/requestComplete"
                });
            }
            //反馈
            if (this.id == "delRole") {
    ...
    function search() {
        ...
        roleTable = $("#softInstallGrid").DataTable({
            ...
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/slowExamination/getCompleteList',
                "data": {
                    manager: manager,
                    requestDate: requestDate,
                    requestDept: requestDept
