...
<table border="1" cellpadding="0" cellspacing="0">
    <h2 style="margin-left: 40%;">
        <%=CommonBean.getParamValue("SZXXMC")%>
    </h2>
    ...
    <tr >
        ...
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.classId}</td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="left" align="center" style="padding-left: 2%;text-align:center;  width: 140px;">缓考科目：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.courseName}</td>
        <td class="left" align="center" style="padding-left: 2%;text-align:center;  width: 140px;">缓考原因：</td>
