    ...
    <form id="dataForm" method="post" enctype="multipart/form-data">
        <div class="modal-content block-fill-white">
            <div class="modal-header">
                ...
                <input id="competitionGuidanceId" name="id" hidden value="${competitionGuidance.id}">
            </div>
            <div class="modal-body clearfix">
                ...
                <div class="controls">
                    <div class="form-row">
                        ...
                        <div class="col-md-9">
                            <input id="teacherName" name="teacherName" type="text"
                                   value="${competitionGuidance.teacherName}" keycode="${competitionGuidance.deptId},${competitionGuidance.teacherId}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-9">
                            <input id="competitionName" name="competitionName" type="text" value="${competitionGuidance.competitionName}" placeholder="请填写名称"/>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-9">
                            <input id="counsellingContent" name="counsellingContent" type="text" value="${competitionGuidance.counsellingContent}" placeholder="简写"/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3 tar">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-9">
                            <input id="educationalLevel" name="educationalLevel" type="text" value="${competitionGuidance.educationalLevel}"/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3 tar">
                        ...
                        <div class="col-md-9">
                            <input id="competitionNumber" name="competitionNumber" type="number" value="${competitionGuidance.competitionNumber}"/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3 tar">
                        ...
                        <div class="col-md-9">
                            <input id="trainingNumber" name="trainingNumber" type="number" value="${competitionGuidance.trainingNumber}"/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3 tar">
                        ...
                        <div class="col-md-9">
                            <input id="classHours" name="classHours" type="number" value="${competitionGuidance.classHours}"/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3 tar">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-9">
                            <input id="competitionPerformance" name="competitionPerformance" type="text" value="${competitionGuidance.competitionPerformance}"/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3 tar">
...
<script>
    ...
    function save() {
        var id = $("#competitionGuidanceId").val();
        ...
        $.post("<%=request.getContextPath()%>/competitionGuidance/competitionGuidanceEdit", {
            id:id,
