        ...
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="block block-drop-shadow content">
                    ...
                    <table id="provincialDocumentGrid" cellpadding="0" cellspacing="0" width="100%"
...
<script>
    ...
    $(document).ready(function () {
        ...
        roleTable.on('click', 'tr a', function () {
            ...
            if (this.id == "uRole") {
                $("#dialog").load("<%=request.getContextPath()%>/policyDocument/addPolicyDocument?id=" + id +"&type=2");
                $("#dialog").modal("show");
            }
            if (this.id == "upload"){
            ...
            if (this.id == "delRole") {
                swal({
                    ...
                    $.post("<%=request.getContextPath()%>/policyDocument/deleteProvincialDocumentById", {
                        id: id
                    }, function (msg) {
                        swal({
                            title: msg.msg,
    ...
    /*添加*/
    function addRewards() {
        $("#dialog").load("<%=request.getContextPath()%>/policyDocument/addPolicyDocument?type=2");
        $("#dialog").modal("show");
    }
    /*清空*/
    ...
    function searchAssets() {
        ...
        roleTable = $("#provincialDocumentGrid").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/policyDocument/provincialDocumentAction',
                "data": {
            ...
            "columns": [
                ...
                { "data": "fileNumber"},
                { "render": function ()
                    {return "<a id='upload' class='icon-cloud-upload' title='上传附件'>"
                    }
                }
            ],
            "columnDefs": [{
