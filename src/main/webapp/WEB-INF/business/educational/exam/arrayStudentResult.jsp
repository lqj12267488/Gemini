...
<script>
                ...
                {"data":"flagShow","title":"状态"},
                {
                    ...
                    "render": function (data, type, row) {
                        return '<span class="icon-edit" title="修改" onclick=editstudentArray("' + row.id + '")/>&ensp;&ensp;' +
                            '<span class="icon-trash" title="删除" onclick=delstudentArray("' + row.id + '","'+row.studentName+'")/>&ensp;&ensp;';
                    }
                }
            ],
    ...
    function delstudentArray(id,studentName) {
        swal({
            title: "您确定要删除本条信息?",
            ...
            $.get("<%=request.getContextPath()%>/exam/array/student/del?id=" + id, function (data) {
                swal({
                    title: data.msg,
                    type: "success"
                });
    ...
    function search() {
        ...
        if (did != undefined || did != null || did=="") {
            table.ajax.url("<%=request.getContextPath()%>/exam/array/student/getStudentArrayList?departmentsId="+did+"&examId=${examId}").load();
    ...
    function back() {
        $("#right").load("<%=request.getContextPath()%>/exam/auto/student");
    }
</script>