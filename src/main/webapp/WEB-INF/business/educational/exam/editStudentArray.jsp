...
<div class="modal-dialog">
    <input id="examId" name="examId" value="${arrayStudent.examId}" hidden>
    <input id="arrayId" name="arrayId" hidden value="${arrayStudent.id}"/>
                ...
                <div id="roomProperty"  class="form-row">
                    ...
                    <div class="col-md-9">
                        <div style="white-space:nowrap;">
                            <input id="roomShow" type="text" onclick="showTree()" value="${arrayStudent.roomName}"readonly/>
                        </div>
                        <div id="menuContent" class="menuContent">
                            <ul id="roomTree" class="ztree"></ul>
                        </div>
                        <input id="roomid" type="hidden" value="${arrayStudent.roomId}"/>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function save() {
        ...
        showSaveLoading();
        $.post("<%=request.getContextPath()%>/exam/array/student/save", {
            id:$("#arrayId").val(),
            roomId : $("#roomid").val()
        }, function (data) {
            hideSaveLoading();
