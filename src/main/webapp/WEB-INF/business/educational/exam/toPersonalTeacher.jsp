    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="content">
                    <table id="toPersonalTeacherTable" cellpadding="0" cellspacing="0" width="100%"
...
<script>
    ...
    $(document).ready(function () {
        table = $("#toPersonalTeacherTable").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
        ...
        table.on('click', 'tr a', function () {
            ...
            if(this.id == "searchPersonalResult"){
                $("#right").load( "<%=request.getContextPath()%>/exam/personal/teacher/result?examId="+data.examId+"&examName="+data.examName);
            }
        });
    })
