...
<script>
            ...
            "columns": [
                ...
                {"data": "endTime", "title": "结束时间"},
                {
                    ...
                    "render": function (data, type, row) {
                        return '<span class="icon-male" title="设置监考教师" onclick=addExamTeacher("' + row.examName + '","' + row.examId + '")/>';
    ...
    function addExamTeacher(examName, examId) {
        $("#right").load("<%=request.getContextPath()%>/exam/teacher/toAddExamRoomTeacher", {
