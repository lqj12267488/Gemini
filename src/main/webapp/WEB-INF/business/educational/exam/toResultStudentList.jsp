    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="content">
                    <table id="toResultStudentTable" cellpadding="0" cellspacing="0" width="100%"
...
<script>
    ...
    $(document).ready(function () {
        table = $("#toResultStudentTable").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
            ...
            "columns": [
                ...
                { "title": "操作",
                    "render": function (date,type,row) {
                        return '<a class="icon-eye-open" title="查看考试安排" id="searchStudentExamCourseResult"/>';
                    }
                }
            ],
            'order': [[0, 'desc']],
        ...
        table.on('click', 'tr a', function () {
            ...
            if(this.id == "searchStudentExamCourseResult"){
                $("#right").load( "<%=request.getContextPath()%>/exam/result/final/student?examId="+data.examId+"&examName="+data.examName);
            }
        });
    })
