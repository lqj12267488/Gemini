...
<script>
    ...
    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/exam/course/getClassTreeForExam?courseType=${courseType}&departmentsId=${departmentsId}&examCourseId=${examCourseId}", function (data) {
    ...
    function save() {
        ...
        if(id.length==0){
            ...
            showSaveLoading();
            $.post("<%=request.getContextPath()%>/exam/course/saveExamClass", {
                ids: id,
