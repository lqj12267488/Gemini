    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="content">
                    <table id="toStudentTable" cellpadding="0" cellspacing="0" width="100%"
...
<script>
    ...
    $(document).ready(function () {
        table = $("#toStudentTable").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
            ...
            "columns": [
                ...
                { "title": "操作",
                    "render": function (date,type,row) {
                        return '<a class="icon-user" title="设置考生" id="setExamStudent" />';
                    }
                }
            ],
            'order': [[0, 'desc']],
        ...
        table.on('click', 'tr a', function () {
            ...
            if(this.id == "setExamStudent"){//跳转设置考生页面
                $("#right").load( "<%=request.getContextPath()%>/exam/student/setExamStudent?examId="+data.examId+"&examName="+data.examName);
            }
        });
    })
