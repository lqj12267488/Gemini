    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="content">
                    <table id="toRoomTable" cellpadding="0" cellspacing="0" width="100%"
...
<script>
    ...
    $(document).ready(function () {
            ...
            "columns": [
                ...
                { "title": "操作",
                    "render": function (date,type,row) {
                        return '<a class="icon-home" title="设置考试场地" id="setExamRoom" />';
                    }
                }
            ],
            'order': [[0, 'desc']],
        ...
        table.on('click', 'tr a', function () {
            ...
            if(this.id == "setExamRoom"){//跳转设置考试场地页面
                $("#right").load("<%=request.getContextPath()%>/exam/room/setExamRoom?examId="+data.examId+"&examName="+data.examName);
            }
        });
    })
