...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        <div class="modal-header">
            ...
            <input id="w_id" hidden value="${medicine.id}">
        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls" >
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-10">
                        <input id="w_medicineName" type="text" value="${medicine.medicineName}"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-10">
                        <input id="w_medicineNum" type="text"  maxlength="10" placeholder="最多输入10个字"  value="${medicine.medicineNum}">
                    </div>
                </div>

                <div class="form-row">
                    <div class="col-md-2 tar">
                        <span class="iconBtx">*</span>  批准时间：
                    </div>
                    <div class="col-md-10">
                        <input id="w_publishDate" type="date" value="${medicine.publishDate}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-10">
                        <input id="w_validityTerm" type="date" value="${medicine.validityTerm}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-10">
                        <textarea id="w_remark" type="text"
                                  ...
                                  value="${medicine.remark}">${medicine.remark}</textarea>
                    </div>
                </div>
        ...
        <div class="modal-footer">
            <button id="saveBtn" type="button" class="btn btn-success btn-clean" onclick="saveMedicine()">保存</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var ppid = $("#w_id").val();
        if(ppid!=""){
            $("#w_personId").val("${medicine.personId}");
            $("#w_personId").attr("keycode", "${medicine.deptId}");
        }
        if($("#flag").val()=='on'){
            $("#saveBtn").hide();
    ...
    function saveMedicine() {
        ...
        if($("#w_medicineName").val()=="" || $("#w_medicineName").val() =="0" || $("#w_medicineName").val() == undefined){
            swal({
                title: "请填写国家医药证书名称！",
                type: "info"
            });
        ...
        if($("#w_medicineNum").val()=="" || $("#w_medicineNum").val() =="0" || $("#w_medicineNum").val() == undefined){
            swal({
                title: "请填写证书号！",
                type: "info"
            });
        ...
        if($("#w_validityTerm").val()=="" || $("#w_validityTerm").val() =="0" || $("#w_validityTerm").val() == undefined){
            swal({
                title: "请选择有效期！",
                type: "info"
            });
        ...
        showSaveLoading();
        $.post("<%=request.getContextPath()%>/teacherResult/saveTeachingResult/medicine", {
            id: pid,
            personId: headTList[1],
            deptId: headTList[0],
            typicalFlag: $("#w_typicalFlag").val(),
            role: $("#w_role").val(),
            medicineNum: $("#w_medicineNum").val(),
            medicineName: $("#w_medicineName").val(),
            publishDate: $("#w_publishDate").val(),
            validityTerm: $("#w_validityTerm").val(),
            remark: $("#w_remark").val()
        }, function (msg) {
            hideSaveLoading();
            if (msg.status == 1) {
