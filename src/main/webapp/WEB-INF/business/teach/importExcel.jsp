    ...
    <div class="modal-content block-fill-white">
            ...
            <div class="controls">
                <div class="form-row">
                    <div class="col-md-12 tar">
                        <form id="importCmte" enctype="multipart/form-data" method="post">
        ...
        <div class="modal-footer">
            <a class="btn btn-default btn-clean"
               href="<%=request.getContextPath()%>/teach/getExcelTemplate?flag=${flag}">下载模板</a>
...
<script>
    ...
    function importExcel() {
        ...
        $.ajax({
            url: '<%=request.getContextPath()%>/teach/importExcel?flag=${flag}',
            type: "post",
            data: form,
            processData: false,
            contentType: false,
