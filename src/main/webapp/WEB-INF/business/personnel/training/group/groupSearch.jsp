...
<script>
    ...
    $(document).ready(function () {
        ...
        searchTable = $("#searchGrid").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/training/group/getSearchList',
            },
            "destroy": true,
            "columns": [
        ...
        searchTable.on('click', 'tr a', function () {
            ...
            if (this.id == "handleFlowTtrack") {
                $("#right").load("<%=request.getContextPath()%>/getWotkflowLog", {
                    ...
                    url: "<%=request.getContextPath()%>/training/group/auditGroupById?id=" + id,
                    backUrl: "/training/group/search"
                });
            }
            //反馈
    ...
    function searchclear() {
        ...
        $("#date").val("");
        searchTable.ajax.url("<%=request.getContextPath()%>/training/group/getSearchList").load();
    }
    ...
    function search() {
        ...
        if (type == "" && date == "" ) {
            ...
            searchTable.ajax.url("<%=request.getContextPath()%>/training/group/getSearchList?trainingType="+type+"&trainingDate="+date).load();
        }
    }
</script>
