...
<table border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.requestDept}</td>
        <td align="center"  class="left" style="padding-left: 2%;text-align:center; width: 140px;">经办人：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.requester}</td>
    </tr>
    <tr>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">申请日期：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.requestDate}</td>
    ...
    <tr>
        ...
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.trainingDate}</td>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">培训周期(天)：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.trainingDays}</td>
    </tr>
    <tr>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">培训地点：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.trainingPlace}</td>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">主办方：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.trainingOrganizers}</td>
    </tr>
    <tr>
        <td align="center"  class="left" style="padding-left: 2%;text-align:center; width: 140px;">项目：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.trainingProject}</td>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">培训项目名称：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.trainingProjectName}</td>
    </tr>
    <tr>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">培训人数：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.trainingPeopleNumber}</td>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">费用(天/人)：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.trainingFee}</td>
    </tr>
    <tr>
        <td align="center"  class="left" style="padding-left: 2%;text-align:center; width: 140px;">培训类别：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.trainingTypeShow}</td>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">培训目的：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${groupTraining.trainingPurpose}</td>
    </tr>
</table>
