...
<script>
    ...
    $(document).ready(function () {
        var id = $("#id").val();
        $.get("<%=request.getContextPath()%>/training/group/getEmpTreeForReport?deptId=${deptId}&id="+id, function (data) {
    ...
    function save() {
        ...
        if(id.length==0){
            ...
            $.post("<%=request.getContextPath()%>/training/group/checkSaveReportTeacher", {
                ids: id,
                deptId: '${deptId}',
                id: '${id}'
                ...
                if (msg.status == 1) {
                    ...
                    $.post("<%=request.getContextPath()%>/training/group/saveReportTeacher", {
                        ids: id,
                        deptId: '${deptId}',
                        id: '${id}'
