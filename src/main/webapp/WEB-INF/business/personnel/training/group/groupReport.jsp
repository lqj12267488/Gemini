            ...
            <div class="block">
                ...
                <div class="block block-drop-shadow content">
                    <div class="form-row block" style="overflow-y:auto;">
                        <table id="reportGroupGrid" cellpadding="0" cellspacing="0" width="100%"
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $("#reportGroupGrid").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/training/group/upGetTrainingList?flag=3',
            },
            "destroy": true,
            "columns": [
        ...
        table.on('click', 'tr a', function () {
            ...
            if(this.id == "reportTeacher"){
                $("#right").load("<%=request.getContextPath()%>/training/group/reportTeacherList?deptId=${deptId}&id="+id+"&trainingProjectName="+trainingProjectName);
            }
        });
    ...
    function search() {
        ...
        table.ajax.url("<%=request.getContextPath()%>/training/group/upGetTrainingList?flag=3"+"&trainingType="+type+"&requestDate="+date).load();
    }
