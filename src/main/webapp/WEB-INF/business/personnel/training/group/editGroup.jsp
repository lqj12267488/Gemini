        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls" >
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="trainingDays" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" value="${groupTraining.trainingDays}" />
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="trainingPlace" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" value="${groupTraining.trainingPlace}" />
                    </div>
                    <div class="col-md-2 tar">
                        <span class="iconBtx">*</span>主办方
                    </div>
                    <div class="col-md-4">
                        <input id="trainingOrganizers" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" value="${groupTraining.trainingOrganizers}" />
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-2 tar">
                    ...
                    <div class="col-md-4">
                        <input id="trainingProject" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" value="${groupTraining.trainingProject}" />
                    </div>
                    <div class="col-md-2 tar">
                        <span class="iconBtx">*</span>培训项目名称
                    </div>
                    <div class="col-md-4">
                        <input id="trainingProjectName" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"  value="${groupTraining.trainingProjectName}" />
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-2 tar">
                    ...
                    <div class="col-md-4">
                        <input id="trainingFee"  onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" value="${groupTraining.trainingFee}" />
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-10">
                        <input id="trainingPurpose" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" value="${groupTraining.trainingPurpose}" />
                    </div>
                </div>
            </div>
        </div>
        <div class="modal-footer">
            <button type="button" id="saveBtn" class="btn btn-success btn-clean" onclick="saveTraining()">保存</button>
...
<script>
    ...
    function saveTraining() {
        ...
        $.post("<%=request.getContextPath()%>/training/group/saveTraining", {
            ...
            //alert(msg.msg);
            $("#dialog").modal('hide');
            $('#groupTrainingGrid').DataTable().ajax.reload();
