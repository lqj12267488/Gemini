            ...
            <div class="block">
                ...
                <div class="block block-drop-shadow content">
                    ...
                    <div class="form-row block" style="overflow-y:auto;">
                        <table id="personalTrainingGrid" cellpadding="0" cellspacing="0" width="100%"
...
<input id="workflowCode" hidden value="T_RS_TRAINING_WF02">
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $("#personalTrainingGrid").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/training/personal/getTrainingList',
            },
            "destroy": true,
            "columns": [
        ...
        table.on('click', 'tr a', function () {
            ...
            if (this.id == "editTraining") {
                $("#dialog").load("<%=request.getContextPath()%>/training/personal/getTrainingById?id=" + id);
                $("#dialog").modal("show");
            }
            if (this.id == "delTraining") {
                ...
                swal({
                    ...
                    $.get("<%=request.getContextPath()%>/training/personal/deleteTrainingById?id=" + id, function (msg) {
                        swal({
                            title: msg.msg,
                            type: "success"
                        });
    ...
    function addTraining() {
        $("#dialog").load("<%=request.getContextPath()%>/training/personal/editTraining");
        $("#dialog").modal("show");
    }
    function search() {
        var date = $("#date").val();
        ...
        if (type == "" && date == "") {
            ...
            table.ajax.url("<%=request.getContextPath()%>/training/personal/getTrainingList?trainingType="+type+"&requestDate="+date).load();
        }
    }
    ...
    function searchclear() {
        $("#date").val("");
        $("#type").val("");
        table.ajax.url("<%=request.getContextPath()%>/training/personal/getTrainingList").load();
    }
