...
<div class="form-row">
    ...
    <div class="col-md-4">
        <input id="trainingPlace" value="${personalTraining.trainingPlace}" />
    </div>
    <div class="col-md-2 tar">
        主办方
    </div>
    <div class="col-md-4">
        <input id="trainingOrganizers"  value="${personalTraining.trainingOrganizers}" />
    </div>
</div>
<div class="form-row">
    <div class="col-md-2 tar">
    ...
    <div class="col-md-4">
        <input id="trainingProject" value="${personalTraining.trainingProject}" />
    </div>
    <div class="col-md-2 tar">
        培训项目名称
    </div>
    <div class="col-md-4">
        <input id="trainingProjectName" value="${personalTraining.trainingProjectName}" />
    </div>
</div>
...
<div class="form-row">
    ...
    <div class="col-md-4">
        <input id="trainingFee" value="${personalTraining.trainingFee}" />
    </div>
</div>
...
<div class="form-row">
    ...
    <div class="col-md-10">
        <input id="trainingPurpose" value="${personalTraining.trainingPurpose}" />
    </div>
</div>
