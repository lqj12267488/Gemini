...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls" >
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="f_requestDate" type="date" class="validate[required,maxSize[100]] form-control"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="f_startTime" type="date" onblur="cha()" class="validate[required,maxSize[100]] form-control"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="f_endTime" type="date" onblur="cha()"  class="validate[required,maxSize[100]] form-control"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="x_cancelStartTime" type="date" class="validate[required,maxSize[100]] form-control"
                               value="${leave.cancelStartTime}" onblur="chaa()"  />
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="x_cancelEndTime" type="date" class="validate[required,maxSize[100]] form-control"
                               value="${leave.cancelEndTime}" onblur="chaa()"  />
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
        ...
        <div class="modal-footer">
            <button type="button" id="saveBtn" class="btn btn-success btn-clean" onclick="saveLeaveCancel()">保存</button>
