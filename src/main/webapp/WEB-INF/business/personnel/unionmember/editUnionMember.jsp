        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="f_memberNumber" type="text" maxlength="10" placeholder="最多输入10个字"  onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"  value="${unionMember.memberNumber}"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <input id="f_unionDuties" type="text"  maxlength="10" placeholder="最多输入10个字"  onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" value="${unionMember.unionDuties}"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="remark" type="text"  maxlength="30" placeholder="最多输入30个字" value="${unionMember.remark}"/>
                    </div>
                </div>
            </div>
        </div>
