        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input  id="personIdShow" type="text"  readonly="readonly"  value="${unionMember.personIdShow}"/>
                    </div>
                    <input id="f_personId" type="hidden" value="${unionMember.personId}">
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <input  id="deptIdShow" type="text"  onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"value="${unionMember.deptIdShow}" readonly="readonly"/>
                    </div>
                    <input id="f_deptId" type="hidden" value="${unionMember.deptId}">
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
