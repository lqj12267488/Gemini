...
<table border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">请假开始时间：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${leave.startTime}</td>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">请假结束时间：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${leave.endTime}</td>
    </tr>
    <tr>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">请假天数：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${leave.requestDays}</td>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">请假类型：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${leave.leaveType}</td>
    </tr>
    <tr>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">请假原因：</td>
