...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        ...
        <div class="modal-footer">
            <button class="btn btn-info btn-clean" onclick="contractTemplate()">下载模板</button>
...
<script>
    function contractTemplate() {
        window.location.href = "<%=request.getContextPath()%>/TeacherContract/contractTemplate";
    }
    function importInsurance() {
        ...
        $.ajax({
            url: '<%=request.getContextPath()%>/TeacherContract/importTeachContract',
            type: "post",
            data: form,
            processData: false,
            contentType: false,
