...
<script>
    ...
    $(document).ready(function () {
        ...
        roleTable.on('click', 'tr a', function () {
            ...
            if (this.id == "uRole") {
                $("#dialog").load("<%=request.getContextPath()%>/material/getMaterialById?id=" + id);
                $("#dialog").modal("show");
            }
            if(this.id == "upload"){
            ...
            if (this.id == "delRole") {
                swal({
                    ...
                    $.get("<%=request.getContextPath()%>/material/deleteMaterialById?id=" + id, function (msg) {
                        if (msg.status == 1) {
                            swal({
                                title: msg.msg,
                                type: "success"
    ...
    function addMaterial() {
        $("#dialog").load("<%=request.getContextPath()%>/material/addMaterial");
        $("#dialog").modal("show");
    }
    ...
    function search() {
        roleTable = $("#material").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/material/getMaterialList',
                "data": {
