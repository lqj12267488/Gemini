...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        <div class="modal-header">
            ...
            <input id="materialid" hidden value="${material.id}">
        </div>
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="f_uploadPerson" type="text" readonly="readonly"
                               class="validate[required,maxSize[20]] form-control"
                               value="${material.uploadPerson}"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
...
<script>
    ...
    function saveDept() {
        ...
        $.post("<%=request.getContextPath()%>/material/saveMaterial", {
            id: $("#materialid").val(),
