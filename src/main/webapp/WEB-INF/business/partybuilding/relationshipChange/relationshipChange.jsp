...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=DZZBGLX", function (data) {
            addOption(data, 'relationshipChangeType', '${party.relationshipChangeType}');
        });
    })
    function saveRelationship() {
        ...
        if (relationshipChangeType == 1 || relationshipChangeType == 2) {
        ...
        var ids = $("#ids").val();
        showSaveLoading();
        $.post("<%=request.getContextPath()%>/updateRelationshipByIds", {
            ids: ids,
