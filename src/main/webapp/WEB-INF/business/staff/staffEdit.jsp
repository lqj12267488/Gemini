        ...
        <div class="modal-body clearfix">
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                       &lt;%&ndash; <input id="politicalcounselorEdit" value="${data.politicalcounselor}"/>&ndash;%&gt;
                           &lt;%&ndash;<label><input type="radio" name="sex" value="1">是</label>
                           <label><input type="radio" name="sex" value="0">否</label>&ndash;%&gt;
                        <select>
