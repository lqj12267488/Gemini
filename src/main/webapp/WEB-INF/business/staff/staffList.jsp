...
<script>
    ...
    function search() {
        ...
        $("#table").DataTable({
            ...
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/Staff/getStaffList?type=1',
                "data": {
                    groupNameSel:groupNameSel,
                    personid:person
                }
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/Staff/toStaffAdd")
        $("#dialog").modal("show")
    }

    function edit(id) {
        $("#dialog").load("<%=request.getContextPath()%>/Staff/toStaffEdit?id=" + id)
        $("#dialog").modal("show")
    }
