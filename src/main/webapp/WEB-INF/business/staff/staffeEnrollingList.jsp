...
<script>
    ...
    function search() {
        ...
        $("#table").DataTable({
            ...
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/Staff/getStaffList?type=3',
                "data": {
                    groupNameSel:groupNameSel,
                    personid:person
                }
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/Staff/toStaffEnrollingAdd")
        $("#dialog").modal("show")
    }

    function edit(id) {
        $("#dialog").load("<%=request.getContextPath()%>/Staff/toStaffEnrollingEdit?id=" + id)
        $("#dialog").modal("show")
    }
