        ...
        <div class="modal-body clearfix">
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                       <%-- <input id="politicalcounselorEdit" value="${data.politicalcounselor}"/>--%>
                           <%--<label><input type="radio" name="sex" value="1">是</label>
                           <label><input type="radio" name="sex" value="0">否</label>--%>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <%--<input id="psychologicalconsultantEdit" value="${data.psychologicalconsultant}"/>--%>
...
<script>
    $(document).ready(function () {
        $("#politicalcounselorEdit").val(${data.politicalcounselor})
        $("#psychologicalconsultantEdit").val(${data.psychologicalconsultant})
