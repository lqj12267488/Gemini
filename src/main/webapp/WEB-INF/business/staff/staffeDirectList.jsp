...
<script>
    ...
    function search() {
        ...
        $("#table").DataTable({
            ...
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/Staff/getStaffList?type=4',
                "data": {
                    groupNameSel:groupNameSel,
                    personid:person
                }
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/Staff/toStaffDirectAdd")
        $("#dialog").modal("show")
    }

    function edit(id) {
        $("#dialog").load("<%=request.getContextPath()%>/Staff/toStaffDirectEdit?id=" + id)
        $("#dialog").modal("show")
    }
