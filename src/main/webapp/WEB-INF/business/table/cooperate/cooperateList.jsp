    ...
    function search() {
        ...
        $("#table").DataTable({
            ...
            "columns": [
                 ...
                 {"data": "equipmentmoney", "title": "对学校捐赠设备总值（万元）"},
                 {"data": "quasidonationmoney", "title": "对学校准捐赠设备总值(万元)"},
                 {"data": "employmentnumber", "title": "接受毕业生就业数（人）"},
                 {"data": "annualincome", "title": "学校为企业技术服务年收入（万元）"},
                 {"data": "employeesnum", "title": "学校为企业年培训员工数（人天28）"},
                 {"data": "business1starttime", "title": "企业1合作开始日期（年月）"},
                 {"data": "business2starttime", "title": "企业2合作开始日期（年月）"},
                 {"data": "business3starttime", "title": "企业3合作开始日期（年月）"},
                 {"data": "business4starttime", "title": "企业4合作开始日期（年月）"},
                 {"data": "business5starttime", "title": "企业5合作开始日期（年月）"},
