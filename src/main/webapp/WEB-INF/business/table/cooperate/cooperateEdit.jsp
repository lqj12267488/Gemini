            ...
            <div class="controls">
                ...
                <div class="form-row">
                    <div class="col-md-2 tar">
                        <span class="iconBtx">*</span>主要合作企业:
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                        <span class="iconBtx">*</span>企业1名称（全称）
                    </div>
                    <div class="col-md-3">
                        <input id="business1nameEdit" value="${data.business1name}"/>
                    </div>
                    <div class="col-md-3 tar">
                ...
                <div class="form-row">
                    <div class="col-md-3 tar">
                        <span class="iconBtx">*</span>企业2名称（全称）
                    </div>
                    <div class="col-md-3">
                    <input id="business2nameEdit" value="${data.business2name}"/>
                    </div>
                    <div class="col-md-3 tar">
                ...
                <div class="form-row">
                    <div class="col-md-3 tar">
                        <span class="iconBtx">*</span>企业3名称（全称）
                    </div>
                    <div class="col-md-3">
                        <input id="business3nameEdit" value="${data.business3name}"/>
                    </div>
                    <div class="col-md-3 tar">
                ...
                <div class="form-row">
                    <div class="col-md-3 tar">
                        <span class="iconBtx">*</span>企业4名称（全称）
                    </div>
                    <div class="col-md-3">
                        <input id="business4nameEdit" value="${data.business4name}"/>
                    </div>
                    <div class="col-md-3 tar">
                ...
                <div class="form-row">
                    <div class="col-md-3 tar">
                        <span class="iconBtx">*</span>企业5名称（全称）
                    </div>
                    <div class="col-md-3">
                        <input id="business5nameEdit" value="${data.business5name}"/>
                    </div>
                    <div class="col-md-3 tar">
...
<script>
    ...
    function save() {
        ...
        if ($("#business1nameEdit").val() == "" || $("#business1nameEdit").val() == undefined || $("#business1nameEdit").val() == null) {
            swal({
                title: "请填写企业1名称（全称）！",
                type: "warning"
            });
        ...
        if ($("#business2nameEdit").val() == "" || $("#business2nameEdit").val() == undefined || $("#business2nameEdit").val() == null) {
            swal({
                title: "请填写企业2名称（全称）！",
                type: "warning"
            });
        ...
        if ($("#business3nameEdit").val() == "" || $("#business3nameEdit").val() == undefined || $("#business3nameEdit").val() == null) {
            swal({
                title: "请填写企业3名称（全称）！",
                type: "warning"
            });
        ...
        if ($("#business4nameEdit").val() == "" || $("#business4nameEdit").val() == undefined || $("#business4nameEdit").val() == null) {
            swal({
                title: "请填写企业4名称（全称）！",
                type: "warning"
            });
        ...
        if ($("#business5nameEdit").val() == "" || $("#business5nameEdit").val() == undefined || $("#business5nameEdit").val() == null) {
            swal({
                title: "请填写企业5名称（全称）！",
                type: "warning"
            });
        ...
        $.post("<%=request.getContextPath()%>/cooperate/saveCooperate", {
            ...
            business1name:$("#business1nameEdit").val(),
            business2name:$("#business2nameEdit").val(),
            business3name:$("#business3nameEdit").val(),
            business4name:$("#business4nameEdit").val(),
            business5name:$("#business5nameEdit").val(),
        }, function (msg) {
            swal({
                title: msg.msg,
                type: "success"
