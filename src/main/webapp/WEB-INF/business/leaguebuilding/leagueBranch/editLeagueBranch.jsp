...
<input id="id" hidden value="${leagueBranch.id}">
<input id="pId" hidden value="${leagueBranch.pId}">
<div class="col-md-12">
    <div class="block block-drop-shadow">
        ...
        <div class="content controls" style="height: 80%">
            <div class="form-row">
                ...
                <div class="col-md-9">
                    <input id="branchName" type="text" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"maxlength="10" placeholder="最多输入10个字"
                           class="validate[required,maxSize[8]] form-control" value="${leagueBranch.branchName}"/>
            ...
            <div class="form-row">
                ...
                <div class="col-md-9">
                    <textarea id="remark" class="validate[required,maxSize[8]] form-control">${leagueBranch.remark} </textarea>
                </div>
            </div>
            <div class="form-row">
...
<script>
    function saveLeagueBranch() {
        ...
        $.post("<%=request.getContextPath()%>/league/updateLeagueBranch", {
            id: $("#id").val(),
