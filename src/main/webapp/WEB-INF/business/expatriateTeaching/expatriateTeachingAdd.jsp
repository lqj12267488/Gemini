...
<script>
    ...
    function save() {
        ...
        var temp1=startTime.split("-");
        var temp2=endTime.split("-");

        var startDate = new Date(temp1[0],temp1[1],temp1[2]);
        var endDate = new Date(temp2[0],temp2[1],temp2[2]);
        ...
        $.ajax({
            type: "post",
            url: "<%=request.getContextPath()%>/educational/expatriateTeaching/saveExpatriateTeaching",
