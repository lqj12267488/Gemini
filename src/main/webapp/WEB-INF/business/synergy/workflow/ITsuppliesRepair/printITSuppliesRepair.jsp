...
<table border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td align="center">${iTSuppliesRepair.requestDept}</td>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">申请人：</td>
        <td align="center">${iTSuppliesRepair.manager}</td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">设备名称：</td>
        <td align="center">${iTSuppliesRepair.deviceNameShow}</td>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">申请事由：</td>
        <td align="center" >${iTSuppliesRepair.reason}</td>
    </tr>
    <tr>
        <td align="center"class="left" style="padding-left: 2%;text-align:center; width: 140px;">备注：</td>
        <td align="center" colspan="3" >${iTSuppliesRepair.remark}</td>
    </tr>
</table>
