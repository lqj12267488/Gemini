...
<script>
        ...
        roleTable.on('click', 'tr a', function () {
            ...
            if (this.id == "handleDeclare") {
                $("#right").load("<%=request.getContextPath()%>/getWotkflowLog", {
                    ...
                    url: "<%=request.getContextPath()%>/declareApprove/auditDeclareApproveById?id=" + id,
                    backUrl: "/declareApprove/complete"
                });
            }
            //反馈
    ...
    function search() {
        ...
        roleTable = $("#declareApprove").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/declareApprove/getCompleteList',
                "data": {
                    requestDate: requestDate,
                    name: name,
            ...
            "columns": [
                ...
                {"width": "10%", "data": "sexShow", "title": "姓别"},
