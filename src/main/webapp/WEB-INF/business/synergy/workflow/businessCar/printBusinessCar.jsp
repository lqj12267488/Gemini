...
<table border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="left" align="center" style="padding-left: 2%;text-align:center; width: 140px;">起始时间：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.startDate}</td>
        <td class="left" align="center" style="padding-left: 2%;text-align:center; width: 140px;"> 结束时间：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.endDate}</td>
    </tr>
    <tr>
        <td class="left" align="center" style="padding-left: 2%;text-align:center; width: 140px;"> 始发地：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.startPlace}</td>
        <td class="left" align="center" style="padding-left: 2%;text-align:center; width: 140px;"> 目的地：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.endPlace}</td>
    </tr>
    <tr>
        <td class="left" align="center" style="padding-left: 2%;text-align:center; width: 140px;"> 使用车型：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.carTypeShow}</td>
        <td class="left" align="center" style="padding-left: 2%;text-align:center; width: 140px;"> 人数：</td>
