...
<script>
    ...
    $(document).ready(function () {
        ...
        if (workflowId==undefined || workflowId == ""){
         ...
         workflow = $("#workflowGrid").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/funds1/workflowList',
                "data": {
                    id:  $("#id").val(),
    ...
    function seeValues(businessId,url,tableName) {
        ...
        $("#dialogFile").load("<%=request.getContextPath()%>/funds1/getWotkflowLog?businessId="+businessId+"&url="+url+"&tableName="+tableName+"&type=1");
    }
    function checkAll() {
    ...
    function addRelation() {
        ...
        if (length >= 1) {
            ...
            $.post("<%=request.getContextPath()%>/funds1/saveRelationFunds", {
                ids: ids
            }, function (msg) {
                hideSaveLoading();
                swal({
