...
<div class="form-row">
    ...
    <div class="col-md-9">
                        <textarea id="e_reason" readonly="readonly"
                                  ...
                                  value="${funds1.reason}">${funds1.reason}</textarea>
    </div>
</div>
<div class="form-row">
    <div class="col-md-3 tar">
    ...
    <div class="col-md-9">
        <input id="e_amount" type="text"
               class="validate[required,maxSize[100]] form-control"
               value="${funds1.amount}" readonly="readonly"/>
    </div>
</div>
<div class="form-row">
    <div class="col-md-3 tar">
    ...
    <div class="col-md-9">
        <input id="f_requestEr" type="text"
               class="validate[required,maxSize[100]] form-control"
               value="${funds1.manager}" readonly="readonly"/>
    </div>
</div>
<div class="form-row">
    <div class="col-md-3 tar">
    ...
    <div class="col-md-9">
        <input id="f_requestDept" type="text"
               class="validate[required,maxSize[100]] form-control"
               value="${funds1.requestDept}" readonly="readonly"/>
    </div>
</div>
<div class="form-row">
    <div class="col-md-3 tar">
    ...
    <div class="col-md-9">
        <input id="f_requestDate" type="text"
               class="validate[required,maxSize[100]] form-control"
               value="${funds1.requestDate}" readonly="readonly"/>
    </div>
</div>
<div class="form-row">
    <div class="col-md-3 tar">
    ...
    <div class="col-md-9">
        <textarea id="a_remark" class="validate[required,maxSize[100]] form-control" readonly="readonly">${funds1.remark}</textarea>
    </div>
</div>
<div class="form-row">
    <div class="col-md-3 tar">
...
<input id="h_id" hidden value="${funds1.id}">
<input id="printFunds" hidden value="<%=request.getContextPath()%>/funds1/printFunds?id=${funds1.id}">
<script>
    ...
    function fundAudit() {
        $("#fuAudit").load("<%=request.getContextPath()%>/funds1/processLoadIndexUnAudit?id=${funds1.id}");
    }
    function fAudit(url, tableName, businessId,flag) {
        $("#dialogFile").load("<%=request.getContextPath()%>/funds1/getFundsLog", {
            id: businessId,
            url:url,
            tableName:tableName,
