...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        <div class="modal-header">
            ...
            <input id="e_id" hidden value="${funds1.id}">
        </div>
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="e_requestdept" type="text" readonly value="${funds1.requestDept}"
                               class="validate[required,maxSize[100]] form-control"
                        />
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="e_manager" type="" readonly value="${funds1.manager}"
                               class="validate[required,maxSize[100]] form-control"
                        />
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="date" type="datetime-local"
                               class="validate[required,maxSize[100]] form-control" value="${funds1.requestDate}"
                        />
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <textarea id="e_remark" maxlength="330" placeholder="最多输入330个字"
                                  class="validate[required,maxSize[100]] form-control"
                                  value="${funds1.remark}">${funds1.remark}</textarea>
                    </div>
                </div>
            </div>
        </div>
...
<%--<input id="roleCache" hidden value="${funds1.roletype}">--%>
<script>
    ...
    function save() {
        ...
        $.post("<%=request.getContextPath()%>/funds1/saveFunds", {
            id: $("#e_id").val(),
            amount: $("#e_amount").val(),
            remark: $("#e_remark").val(),
            requestDate: date,
