...
<table border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">用途：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.use}</td>
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">标准(元/人)：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.standard}</td>
    </tr>
    <tr>
        ...
        <td align="center" class="left" style="padding-left: 2%;text-align:center; width: 140px;">总金额：</td>
    ...
    <tr>
        ...
        <td align="center" class="left1" colspan="3">${data.remark}</td>
    </tr>
</table>
