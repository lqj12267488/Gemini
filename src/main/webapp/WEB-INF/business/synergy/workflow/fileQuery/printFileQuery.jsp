...
<table border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="left"  style="padding-left: 2%;text-align:center; width: 140px;">&nbsp;&nbsp;&nbsp;&nbsp;申请人：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.requester}</td>
        <td class="left"  style="padding-left: 2%;text-align:center; width: 140px;">&nbsp;&nbsp;&nbsp;&nbsp;申请日期：</td>
    ...
    <tr>
        <td class="left"  style="padding-left: 2%;text-align:center; width: 140px;">&nbsp;&nbsp;&nbsp;&nbsp;查询内容：</td>
        <td colspan="3" align="center">${data.queryContent}</td>
    </tr>
    <tr>
        <td class="left"  style="padding-left: 2%;text-align:center; width: 140px;">&nbsp;&nbsp;&nbsp;&nbsp;备注：</td>
        <td  colspan="3" align="center">${data.remark}</td>
    </tr>
</table>
