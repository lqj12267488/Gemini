            ...
            <div class="block">
                ...
                <div class="block block-drop-shadow content">
                    <div class="form-row block" style="overflow-y:auto;">
                        <table id="cameraGrid" cellpadding="0" cellspacing="0" width="100%"
...
<script>
        ...
        cameraTable.on('click', 'tr a', function () {
            ...
            if (this.id == "seCamera") {
                $("#right").load("<%=request.getContextPath()%>/getWotkflowLog", {
                    ...
                    url: "<%=request.getContextPath()%>/camera/auditCameraById?id=" + id,
                    backUrl: "/camera/complete"
                });
            }
            //反馈
            if (this.id == "delRole") {
    ...
    function search() {
        ...
        cameraTable = $("#cameraGrid").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/camera/getCameraListComplete',
                "data": {
                    requester: requester,
                    requestDate: requestDate,
                    requestDept: requestDept
            ...
            "columns": [
                ...
                { "width":"12%", "data": "machineNumber", "title": "摄像机机位数"},
                ...
                {"width": "8%", "data": "feedBack", "title": "反馈意见"},
                {
                    "width": "8%","title": "操作",
                    "render": function () {
                        return "<a id='seCamera' class='icon-search' title='查看流程轨迹'></a>&nbsp;&nbsp;&nbsp;" +
