...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        <div class="modal-header">
            ...
            <input id="e_id" hidden value="${funds2.id}">
        </div>
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="e_requestdept" type="text" readonly value="${funds2.requestDept}"
                               class="validate[required,maxSize[100]] form-control"
                        />
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="e_manager" type="" readonly value="${funds2.manager}"
                               class="validate[required,maxSize[100]] form-control"
                        />
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="date" type="datetime-local"
                               class="validate[required,maxSize[100]] form-control" value="${funds2.requestDate}"
                        />
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <textarea id="e_remark" maxlength="330" placeholder="最多输入330个字"
                                  class="validate[required,maxSize[100]] form-control"
                                  value="${funds2.remark}">${funds2.remark}</textarea>
                    </div>
                </div>
            </div>
        </div>
...
<%--<input id="roleCache" hidden value="${funds2.roletype}">--%>
<script>
