...
<script>
        ...
        roleTable.on('click', 'tr a', function () {
            ...
            if (this.id == "handleFunds") {
                $("#right").load("<%=request.getContextPath()%>/getWotkflowLog", {
                    ...
                    url: "<%=request.getContextPath()%>/funds2/auditFundsById?id=" + id,
                    backUrl: "/funds2/complete"
                });
            }
            if (this.id == "relationFunds") {
                $("#right").load("<%=request.getContextPath()%>/funds2/relationRequest?id=" + id +"&type=2");
            }
    ...
    function search() {
        ...
        roleTable = $('#funds2').DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/funds2/getFundsListComplete',
                "data": {
                    requestDate: requestDate,
                    requestDept: requestDept,
                    manager : manager
