...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <button type="button" id="clo1" class="close" data-dismiss="modal" aria-hidden="true"
                    onclick="custom_close()">
                &times;
            </button>
        </div>
        <div class="modal-body clearfix">
            <div class="controls" id="funds2RelationTable">
            </div>
            <div class="form-row">
...
<script>
    ...
    $(document).ready(function () {
        ...
        */
        $("#funds2RelationTable").load('<%=request.getContextPath()%>${url}', {
