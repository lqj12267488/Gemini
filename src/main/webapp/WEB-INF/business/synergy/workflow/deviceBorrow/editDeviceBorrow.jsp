...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        <div class="modal-header">
            ...
            <input id="deviceBorrowid" name="deviceBorrowid" type="hidden" value="${deviceBorrow.id}">
        </div>
        ...
        <div class="modal-footer">
            <button type="button" id="saveBtn" class="btn btn-success btn-clean" onclick="saveDeviceBorrow()">保存</button>
