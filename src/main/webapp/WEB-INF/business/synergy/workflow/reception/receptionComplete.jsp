        ...
        roleTable.on('click', 'tr a', function () {
            ...
            if (this.id == "handleFlowTtrack") {
                $("#right").load("<%=request.getContextPath()%>/getWotkflowLog", {
                    ...
                    url: "<%=request.getContextPath()%>/reception/auditReceptionById?id=" + receptionProcessId,
                    backUrl: "/reception/complete"
                });
            }
            //反馈
    ...
    function search() {
        ...
        roleTable = $("#receptionGrid").DataTable({
            ...
            "columns": [
                ...
                {"width": "13%", "data": "receptionTime", "title": "接待时间"},
                {"width": "13%", "data": "receptionReason", "title": "接待事由"},
                {"width": "13%", "data": "tel", "title": "联系电话"},
                {"width": "13%", "data": "visitLeader", "title": "来访主要领导及职务"},
                {"width": "13%", "data": "visitNumber", "title": "来访人数"},
                {"width": "13%", "data": "receptionPlace", "title": "接待地点"},
                {"width": "13%", "data": "entourage", "title": "拟陪同人员"},
                {"width": "13%", "data": "isNeedVehicle", "title": "是否需要用车"},
