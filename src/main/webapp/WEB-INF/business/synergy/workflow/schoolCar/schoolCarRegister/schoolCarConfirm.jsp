...
<script>
    ...
    $(document).ready(function () {
        ...
        schoolCarTable.on('click', 'tr a', function () {
            ...
            //确认登记信息
            if (this.id == "confirm") {
                $.post("<%=request.getContextPath()%>/getConfirmStatus", {
                    ...
                    if (msg.status == 1) {
                        ...
                        $("#dialog").load("<%=request.getContextPath()%>/schoolCar/schoolCarConfirmRegister?id=" + deviceid);
                        $("#dialog").modal("show");
                    }
                })
            }
    ...
    function search() {
        ...
        schoolCarTable = $("#schoolCarGrid").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/schoolCar/getSchoolCarConfirmList',
                "data": {
                    requester: requester,
                    requestDate: requestDate,
                    requestDept: requestDept
...
//                {"width": "8%", "data": "feedback", "titl e": "反馈意见"},
                ...
                {"width": "5%","title": "操作","render": function () {return "<a id='confirm' class='icon-upload-alt' title='确认登记信息'></a>";}}
            ],
            'order' : [1,'desc'],
            "dom": 'rtlip',
            language: language
