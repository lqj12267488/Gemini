...
<script>
    ...
    $(document).ready(function () {
        ...
        roleTable.on('click', 'tr a', function () {
            ...
            var id = data.id;
            if (this.id == "uFunds") {
                $("#dialog").load("<%=request.getContextPath()%>/funds3/getFundsById?id=" + id);
                $("#dialog").modal("show");
            }
            if (this.id == "relationFunds") {
                $("#right").load("<%=request.getContextPath()%>/funds3/relationRequest?id=" + id+"&type=0");
            }
            if (this.id == "delFunds") {
                ...
                swal({
                    ...
                    $.get("<%=request.getContextPath()%>/funds3/deleteFundsById?id=" + id, function (msg) {
                        if (msg.status == 1) {
                            swal({
                                title: msg.msg,
                                type: "success"
    ...
    function addFunds() {
        $("#dialog").load("<%=request.getContextPath()%>/funds3/addFunds");
        $("#dialog").modal("show");
    }
    ...
    function search() {
        ...
        roleTable = $('#funds3').DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/funds3/search',
                "data": {
                    requestDate: requestDate,
                }
            },
