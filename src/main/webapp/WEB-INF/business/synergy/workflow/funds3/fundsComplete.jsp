...
<script>
        ...
        roleTable.on('click', 'tr a', function () {
            ...
            if (this.id == "handleFunds") {
                $("#right").load("<%=request.getContextPath()%>/getWotkflowLog", {
                    ...
                    url: "<%=request.getContextPath()%>/funds3/auditFundsById?id=" + id,
                    backUrl: "/funds3/complete"
                });
            }
            if (this.id == "relationFunds") {
                $("#right").load("<%=request.getContextPath()%>/funds3/relationRequest?id=" + id +"&type=2");
            }
    ...
    function search() {
        ...
        roleTable = $('#funds3').DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/funds3/getFundsListComplete',
                "data": {
                    requestDate: requestDate,
                    requestDept: requestDept,
                    manager : manager
