...
<table border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.caption}</td>
        <td align="center" class="left"  style="padding-left: 2%;text-align:center; width: 140px;" >发布渠道：</td>
        <td align="center" class="left1" style="padding-left: 2%;text-align:center; width: 140px;">${data.distributionChannelsShow}</td>
    </tr>
    <tr >
