...
<div class="modal-dialog" style="width: 700px">
    <div class="modal-content block-fill-white">
        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-10">
                        <input id="activityContent" type="text" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"
        ...
        <div class="modal-footer">
            <button type="button" id="saveBtn" id="saveBtn" class="btn btn-success btn-clean" onclick="save()">
                保存</button>
            <button type="button" class="btn btn-default btn-clean" data-dismiss="modal">
                关闭</button>
        </div>
    </div>
    <input id="id" name="id" type="hidden" value="${schoolActivity.id}">
</div>
<script>
    /**功能：修改的申请信息保存
     * create by wq
