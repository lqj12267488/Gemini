                ...
                <div id="layout" style="display:none;z-index:999;position:absolute;width: 100%;height: 100%;text-align: center"></div>
                    <div class="controls" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-9">
                                <div>
                                    <input id="suppliesnameShow" type="text" onclick="showMenu()"placeholder="请点击选择"
...
<script>
    ...
    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/common/getUserDictToTree?name=JSJHC", function (data) {
            ...
            var node;
            var lis = $("#suppliesname").val().split(",");
            //设置选择节点
            for(var i = 0;i< lis.length;i++){
                node = suppliesnameTree.getNodeByParam("id", lis[i], null);
                var callbackFlag = $("#"+lis[i]).attr("checked");
                suppliesnameTree.checkNode(node, true, false, callbackFlag);
            }
        });
    })
