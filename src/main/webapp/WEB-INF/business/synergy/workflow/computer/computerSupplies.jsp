            ...
            <div class="block">
                ...
                <div class="block block-drop-shadow content">
                    ...
                    <div class="form-row block" style="overflow-y:auto;">
                        <table id="computerSuppliesGrid" cellpadding="0" cellspacing="0" width="100%" style="max-height: 50%;min-height: 10%;"
...
<script>
    var computerSuppliesTable;

    $(document).ready(function () {
        searchUserDic();

        computerSuppliesTable.on('click', 'tr a', function () {
            var data = computerSuppliesTable.row($(this).parent()).data();
            var id = data.id;
            var dicname = data.dicname;
            var editUrl="/business/synergy/workflow/computer/editComputerSupplies";
                ...
                swal({
                    ...
                    $.get("<%=request.getContextPath()%>/userDic/deleteUserDicById?id=" + id, function (msg) {
                        if (msg.status == 1) {
                            ...
                            $('#computerSuppliesGrid').DataTable().ajax.reload();
                        }
                    })
                });
    ...
    function addComputerSupplies() {
        /*urlName 新增页jsp路径*/
        var urlName="/business/synergy/workflow/computer/addComputerSupplies";
    ...
    function searchUserDic() {
        ...
        computerSuppliesTable = $("#computerSuppliesGrid").DataTable({
            "ajax": {
                "type": "post",
            ...
            "columns": [
                ...
                {"width":"50%","data": "dicname", "title": "外设名称"},
