            ...
            <div class="block">
                ...
                <div class="block block-drop-shadow content">
                    <div class="form-row block" style="overflow-y:auto;">
                        <table id="itDeviceRepair" cellpadding="0" cellspacing="0"
...
<script>
        ...
        roleTable.on('click', 'tr a', function () {
            ...
            if (this.id == "handleOfficeItem") {
                $("#right").load("<%=request.getContextPath()%>/getWotkflowLog", {
                    ...
                    url: "<%=request.getContextPath()%>/itdevicerepai/auditITDeviceRepaiById?id=" + id,
                    backUrl: "/itdevicerepai/complete"
                });
            }

            //反馈
            if (this.id == "addItDeviceComplete") {
                var data = roleTable.row($(this).parent()).data();
    ...
    function search() {
        ...
        roleTable = $("#itDeviceRepair").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/itdevicerepai/getITDeviceListComplete',
                "data": {
                    requestDate: requestDate,
                    requestDept: requestDept,
                    requester: requester
            ...
            "columns": [
                ...
                {"width": "15%", "data": "reason", "title": "申请原因"},
                ...
                {"width": "10%", "data": "feedback", "title": "反馈意见"},
                {
                    ...
                    "render": function () {
                        return "<a id='handleOfficeItem' class='icon-search' title='查看流程轨迹'></a>&nbsp;&nbsp;&nbsp;"+
                            "<a id='addItDeviceComplete' class='icon-comments' title='反馈'></a>";
                    }
                }
            ],
            'order' : [1,'desc'],
