        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls" >
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="SupermarketName" class="js-example-basic-single" value="${canteen.name}"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="address" class="js-example-basic-single" value="${canteen.address}"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="personName" class="js-example-basic-single" value="${canteen.personName}"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="personidCard" class="js-example-basic-single" value="${canteen.personidCard}"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="personTel" class="js-example-basic-single" value="${canteen.personTel}"
...
<script>
    ...
    function save() {
       ...
       var endTime = $('#endTime').val();
        ...
        showSaveLoading();
            $.post("<%=request.getContextPath()%>/canteen/canteenSave", {
                id:edit_id,
                name: name,
                address: address,
