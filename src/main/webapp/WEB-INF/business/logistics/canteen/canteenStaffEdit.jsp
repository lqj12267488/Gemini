...
<div class="modal-dialog">
        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls" >
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="edit_staffName" class="js-example-basic-single" value="${canteen.staffName}"
                    ...
                    <div class="col-md-4">
                        <input id="edit_staffidCard" class="js-example-basic-single" value="${canteen.staffidCard}"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="edit_staffPost" class="js-example-basic-single" value="${canteen.staffPost}"
                               onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" maxlength="10" placeholder="最多输入10个字">
                    </div>
                    <div class="col-md-2 tar">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="edit_staffTel" class="js-example-basic-single" value="${canteen.staffTel}"
                               onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" maxlength="11" placeholder="最多输入11个字">
                    </div>
                    <div class="col-md-2 tar">
                        <span class="iconBtx">*</span>所在食堂
                    </div>
                    <div class="col-md-4">
                        <select id="edit_canteenId" />
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-2 tar">
    ...
    <input id="edit_id" value="${canteen.id}" type="hidden" >
</div>
...
<script>
    ...
    $(document).ready(function (){
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=XB", function (data) {
            addOption(data, 'edit_staffSex','${canteen.staffSex}');
        });
        $.get("<%=request.getContextPath()%>/common/getTableDict", {
                id: "id",
                text: "name",
                tableName: "T_ZW_CANTEEN",
                where: " ",
                orderby: " "
            },
            function (data) {
                addOption(data, 'edit_canteenId','${canteen.canteenId}');
            });
    })
    function closeView(){
    ...
    function save() {
       ...
       var canteenId = $('#edit_canteenId').val();
        if (staffName == "") {
            swal({
                title: "填写员工姓名！",
                type: "info"
        ...
        showSaveLoading();
            $.post("<%=request.getContextPath()%>/canteen/canteenStaffSave", {
                id:edit_id,
                staffName: staffName,
