...
<div class="modal-dialog"><%--整个页面(有新增页)--%>
    <div class="modal-content block-fill-white"><%--新增页框--%>
        <div class="modal-header"><%--新增页头部--%>
            ...
            <input id="assetsId" hidden value="${id}"/>
        </div>
                    ...
                    <div class="col-md-9">
                        <div>
                            <input id="assetsName" type="text" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"
                                   ...
                                   value="${goodsPurchasing.goodsName}" readonly/>
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <div>
                            <input id="assetsNumAll" type="text" placeholder="请输入数字"
                                   ...
                                   class="validate[required,maxSize[100]] form-control"
                                   value="${goodsPurchasing.goodsNum}" readonly/>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function saveAssets() {
        ...
        $.post("<%=request.getContextPath()%>/assets/saveAssetsList", {
            id: id,
