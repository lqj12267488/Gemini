...
<script>
    ...
    $(document).ready(function () {
        ...
        repairTypeTable.on('click', 'tr a', function () {
            ...
            var editUrl="/business/logistics/repair/editRepairType";
            ...
            if (this.id == "delComputerSupplies") {
                swal({
                    ...
                    $.post("<%=request.getContextPath()%>/repair/deleteRepairTypeById", {
                        id: rid,
                        repairType: diccode
                    }, function (msg) {
                        if(msg.status==1){
    ...
    function addComputerSupplies() {
        /*urlName 新增页jsp路径*/
        var urlName="/business/logistics/repair/editRepairType";
    ...
    function searchUserDic() {
        ...
        repairTypeTable = $("#repairTypeGrid").DataTable({
            ...
            "columns": [
                ...
                {"width":"50%","data": "dicname", "title": "报修类型"},
