                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="supplies_num" type="text" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;"
                               placeholder="最多输入10位整数" class="validate[required,maxSize[20]] form-control" maxlength="10"
                               value="${RepairSupplies.suppliesnum}" />
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
...
<script>
    ...
    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/common/getTableDict", {
            ...
            function (data) {
                addOption(data, "suppliestype", '${repair.repairType}');
            });
        $.get("<%=request.getContextPath()%>/common/getTableDict", {
                id: "dic_code",
                text: "dic_name",
