...
<script>
    ...
    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/xgEvaluation/getStudentTree?groupId=" + "${id}" + "&evaluationType=" + '${evaluationType}', function (data) {
    ...
    function save() {
        ...
        showSaveLoading();
        $.post("<%=request.getContextPath()%>/xgEvaluation/saveGroupEmps", {
            groupId: $("#groupId").val(),
            ids: id,
