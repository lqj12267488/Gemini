...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                <div class="header">
                    <span style="font-size: 15px;margin-left: 20px">${complexTaskName} > 被评教人校验列表</span>
                </div>
                <div class="content">
                    <div class="form-row">
...
<script>
    ...
    $(document).ready(function () {
        ...
        <c:forEach items="${details}" var="index">
            th1 += '<th rowspan="1" >' + '<a title="原评教名称：${index.taskName}">${index.taskShowName}</a>'+ '</th>';
        </c:forEach>
        $("#tr1").html(th1);

        taskDetailTable = $("#taskDetailTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/xgEvaluation/complex/getcheckEmpsList?' +
