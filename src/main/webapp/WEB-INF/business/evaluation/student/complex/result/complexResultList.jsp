...
<script>
    ...
    $(document).ready(function () {
        ...
        ComplexTaskTable = $("#ComplexTaskTable").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/xgEvaluation/complex/getComplexTask?testFlag=1&evaluationType='+eType
            },
            "destroy": true,
            "columns": [
                ...
                {"width": "10%", "data": "startTime", "title": "操作时间"},
                {
                    ...
                    "render": function (date,type,row) {
                        return  '<a class="icon-cog" title="查看考评结果" id="editTaskResult" />&nbsp;&nbsp;&nbsp;'
        ...
        ComplexTaskTable.on('click', 'tr a', function () {
            ...
            if(this.id == "editTaskResult"){// 子考评管理
                $("#right").load( "<%=request.getContextPath()%>/xgEvaluation/complex/getResult?" +
                ...
                $.get("<%=request.getContextPath()%>/xgEvaluation/complex/insertResult?complexTaskId="+data.complexTaskId, function (msg) {
    ...
    function search() {
        ...
        ComplexTaskTable.ajax.url("<%=request.getContextPath()%>/xgEvaluation/complex/getComplexTask?testFlag=1&"+
