...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        ...
        <div class="modal-footer">
            <button class="btn btn-success btn-clean" id="saveBtn" onclick="save()" id="saveBtn">保存</button>
...
<script>
    ...
    function getEmpsCheck() {
        $.get("<%=request.getContextPath()%>/xgEvaluation/getEmpsCheckByTask?id=" + "${id}"+"&evaluationType="+$("#eType").val(), function (data) {
    ...
    function getTree() {
        $.get("<%=request.getContextPath()%>/xgEvaluation/getEmpsByTask?id=" + "${id}", function (data) {
            empTree = $.fn.zTree.init($("#empTree"), setting, data.tree);
    ...
    function save() {
        ...
        showSaveLoading();
        $.post("<%=request.getContextPath()%>/xgEvaluation/saveEmps", {
            taskId: $("#taskId").val(),
            ids: id
        }, function (msg) {
            hideSaveLoading();
