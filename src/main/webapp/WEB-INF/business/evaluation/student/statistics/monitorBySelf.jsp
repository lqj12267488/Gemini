...
<script>
    ...
    $(document).ready(function () {
        taskTable = $("#taskTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/xgEvaluation/getMonitoerTaskBySelf?evaluationType='+eType,
            },
            "destroy": true,
            "columns": [
    ...
    function toEmps(id, taskName) {
        ...
        $("#right").load("<%=request.getContextPath()%>/xgEvaluation/statistics/detailsBySelf", {
            id: id,
            taskName: taskName,
    ...
    function search() {
        ...
        taskTable.ajax.url("<%=request.getContextPath()%>/xgEvaluation/getMonitoerTaskBySelf"
