...
<script>
    ...
    function toEmps(id, taskName) {
        $("#right").load("<%=request.getContextPath()%>/xgEvaluation/statistics/resultEmps", {
            id: id,
            taskName: taskName,
    ...
    function exportList() {
        ...
        $("#exportList").attr("href","<%=request.getContextPath()%>/xgEvaluation/exportEvaluationResultList"
