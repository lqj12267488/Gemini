                ...
                <div class="content">
                    <div class="form-row">
                        ...
                        <a class="btn btn-default btn-clean"
                           href="<%=request.getContextPath()%>/xgEvaluation/exportEvaluationResult?id=${id}&name=${taskName}&flag=0&evaluationType=${evaluationType}">导出
                        </a>
                        <br>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        taskOrderTable = $("#taskOrderTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/xgEvaluation/statistics/getMonitoerEmpsOeder?taskId=' + '${id}'+'&evaluationType='+eType,
            },
            "destroy": true,
            "columns": [
    ...
    function back() {
        $("#right").load("<%=request.getContextPath()%>/xgEvaluation/statistics/order");
    }
