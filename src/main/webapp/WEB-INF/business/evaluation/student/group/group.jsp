...
<script>
    ...
    function search() {
        ...
        groupTable = $("#groupTable").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/xgEvaluation/getGroupList',
                "data": {
                    groupName: groupName,
            ...
            "columns": [
                ...
                {"width": "30%", "data": "groupName", "title": "考评委名称"},
                {"width": "30%", "data": "membersNum", "title": "评委数量"},
                {
                    "width": "40%",
                    "title": "操作",
...
//            'order': [1, 'desc'],
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/xgEvaluation/addGroup");
        $("#dialog").modal("show");
    }
    ...
    function editCopy(id) {
        swal({
            ...
            $.post("<%=request.getContextPath()%>/xgEvaluation/editCopyMemberGroup", {
                id: id
            }, function (msg) {
                swal({
                    title: msg.msg,
    ...
    function addMember(id, memberType) {
        $("#dialog").load("<%=request.getContextPath()%>/xgEvaluation/toSelectMember", {
            id: id,
    ...
    function del(id, groupName) {
        swal({
            ...
            $.post("<%=request.getContextPath()%>/xgEvaluation/deleteGroup", {
                id: id
            }, function (msg) {
    ...
    function edit(id) {
        $("#dialog").load("<%=request.getContextPath()%>/xgEvaluation/toEditGroup?id=" + id);
        $("#dialog").modal("show");
    }
</script>