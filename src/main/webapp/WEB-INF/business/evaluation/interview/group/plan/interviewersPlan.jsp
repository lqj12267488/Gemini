...
<script>
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/addInterviewersPlan");
        $("#dialog").modal("show");
    }

    function editPlan(id) {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/toEditInterviewersPlan", {
            id: id
        });
        $("#dialog").modal("show");
    }
    ...
    function toIndex(id,planName) {
        $("#right").load("<%=request.getContextPath()%>/evaluation/toInterviewersIndex", {
            id: id,
            planName:planName
        });
    }
