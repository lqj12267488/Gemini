...
<script>
    ...
    $(document).ready(function () {
        taskTable = $("#taskTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getMonitorInterviewersTask?evaluationType='+eType,
            },
            "destroy": true,
            "columns": [
    ...
    function toEmps(id, taskName) {
        $("#right").load("<%=request.getContextPath()%>/evaluation/toInterviewers", {
            id: id,
            taskName: taskName,
    ...
    function search() {
        ...
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getMonitorInterviewersTask"
