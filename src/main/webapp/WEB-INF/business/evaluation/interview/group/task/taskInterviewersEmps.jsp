...
<script>
    ...
    function getEmpsCheck() {
        $.get("<%=request.getContextPath()%>/evaluation/getEmpsInterviewersCheckByTask?id=" + "${id}"+"&evaluationType="+$("#eType").val(), function (data) {
    ...
    function getTree() {
        $.get("<%=request.getContextPath()%>/evaluation/getEmpsInterviewersByTaskId?id=" + "${id}", function (data) {
            empTree = $.fn.zTree.init($("#empTree"), setting, data.tree);
