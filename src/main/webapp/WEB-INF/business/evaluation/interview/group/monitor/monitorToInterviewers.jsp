...
<script>
            ...
            "columns": [
                ...
                /*{"data": "total", "title": "得分"},*/
                {
                    ...
                    "render": function (data, type, row) {
                        return '<span class="icon-edit" title="查看" onclick=toEmpDetails("' +
    ...
    function toEmpDetails(id, taskId, name) {
        $("#right").load("<%=request.getContextPath()%>/evaluation/toInterviewersDetails", {
            id: id,
            taskId: taskId,
            name: name,
            taskName: "${taskName}"
    ...
    function back() {
        $("#right").load("<%=request.getContextPath()%>/evaluation/monitorInterviewers");
    }
</script>