...
<script>
    ...
    function xjydxxtjCol(path) {
        ...
        $.post(path+"/evaluation/echartsMenu/getTeacherEcharts?&id="+'${id}'+"&taskName="+'${taskName}'+"&evaluationType="+'${evaluationType}', function (data) {
            var newContent = null;
    ...
    function back() {
        $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/queryTeacherResult");
    }
</script>
