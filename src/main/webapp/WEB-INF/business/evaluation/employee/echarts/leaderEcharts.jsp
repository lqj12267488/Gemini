...
<script>
    ...
    function xjydxxtjCol(path) {
        ...
        $.post(path+"/evaluation/echartsMenu/getLeaderEcharts?&id="+'${id}'+"&taskName="+'${taskName}'+"&evaluationType="+'${evaluationType}', function (data) {
            var newContent = null;
    ...
    function back() {
        $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/queryLeaderResult");
    }
</script>
