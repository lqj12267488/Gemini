...
<div class="modal-dialog">
    ...
    <div class="modal-content block-fill-white">
        <div class="modal-header">
            ...
            <h4 class="modal-title">选择人员<input id="id" hidden value="${id}"></h4>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/evaluation/getPushEmpsByGroup?id=" + "${id}", function (data) {
    ...
    function save() {
        ...
        showSaveLoading();
        $.post("<%=request.getContextPath()%>/evaluation/saveEvaluationPushMember", {
            id: $("#id").val(),
            ids: id
        }, function (msg) {
            if (msg.status == 1) {
