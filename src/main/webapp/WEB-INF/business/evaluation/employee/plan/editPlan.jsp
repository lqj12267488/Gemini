                ...
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="score" type="text" value="${plan.score}"
                               class="validate[required,maxSize[20]] form-control" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" maxlength="10" placeholder="最多输入10位字"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
...
<script>
    ...
    function save() {
        ...
        showSaveLoading();
        $.post("<%=request.getContextPath()%>/evaluation/updatePlan", {
            planId: $("#planId").val(),
            planName: planName,
            remark: remark,
            score: score
