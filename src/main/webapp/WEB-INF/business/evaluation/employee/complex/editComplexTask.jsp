...
<div class="modal-dialog" id="modaldialog">
    ...
    <div class="modal-content block-fill-white">
        <div class="modal-header">
            ...
            <h4 class="modal-title">综合评教详细</h4>
        </div>
        <div class="modal-body clearfix">
            <div class="controls">
                    <div class="form-row">
                        ...
                        <div class="col-md-9">
                            <input id="complexTaskName" type="text" value="${ecTask.complexTaskName}" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" maxlength="30" placeholder="最多输入30个字"/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3 tar">
