...
<script>
    ...
    $(document).ready(function () {
        taskTable = $("#taskTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getTasks?evaluationType=' + eType,
            },
            "destroy": true,
            "columns": [
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/toAddTask?evaluationType=" + eType);
        $("#dialog").modal("show");
    }

    function edit(id) {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/toEditTask", {
            id: id,
    ...
    function toSelectEmps(id, startFlag) {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/toTaskSelectEmps", {
            id: id,
            startFlag: startFlag,
            evaluationType: eType,
        });
    ...
    function searchclear() {
        $("#taskNameSea").val("");
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getTasks?evaluationType=" + eType).load();
    }

    function search() {
        var taskName = $("#taskNameSea").val();
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getTasks?name=" + taskName + "&evaluationType=" + eType).load();
    }
