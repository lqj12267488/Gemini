...
<script>
    ...
    $(document).ready(function () {
        taskTable = $("#taskTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getPeerTasks?evaluationType=' + eType,
            },
            "destroy": true,
            "columns": [
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/toAddTask?evaluationType=" + eType +"&taskType=4");
        $("#dialog").modal("show");
    }
    ...
    function searchclear() {
        $("#taskNameSea").val("");
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getPeerTasks?evaluationType=" + eType).load();
    }

    function search() {
        var taskName = $("#taskNameSea").val();
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getPeerTasks?name=" + taskName + "&evaluationType=" + eType).load();
    }
