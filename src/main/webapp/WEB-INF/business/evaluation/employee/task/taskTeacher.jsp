...
<script>
    ...
    $(document).ready(function () {
        taskTable = $("#taskTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getTeacherTasks?evaluationType=' + eType,
            },
            "destroy": true,
            "columns": [
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/toAddTask?evaluationType=" + eType +"&taskType=0");
        $("#dialog").modal("show");
    }
    ...
    function searchclear() {
        $("#taskNameSea").val("");
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getTeacherTasks?evaluationType=" + eType).load();
    }

    function search() {
        var taskName = $("#taskNameSea").val();
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getTeacherTasks?name=" + taskName + "&evaluationType=" + eType).load();
    }
