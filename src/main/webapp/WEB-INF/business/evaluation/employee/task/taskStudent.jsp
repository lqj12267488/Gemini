...
<script>
    ...
    $(document).ready(function () {
        taskTable = $("#taskTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getStudentTasks?evaluationType=' + eType,
            },
            "destroy": true,
            "columns": [
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/toAddTask?evaluationType=" + eType +"&taskType=1");
        $("#dialog").modal("show");
    }
    ...
    function searchclear() {
        $("#taskNameSea").val("");
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getStudentTasks?evaluationType=" + eType).load();
    }

    function search() {
        var taskName = $("#taskNameSea").val();
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getStudentTasks?name=" + taskName + "&evaluationType=" + eType).load();
    }
