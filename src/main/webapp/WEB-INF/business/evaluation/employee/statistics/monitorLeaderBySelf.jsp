...
<script>
    ...
    $(document).ready(function () {
        taskTable = $("#taskTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getMonitoerLeaderTaskBySelf?evaluationType='+eType,
            },
            "destroy": true,
            "columns": [
    ...
    function search() {
        ...
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getMonitoerLeaderTaskBySelf"
