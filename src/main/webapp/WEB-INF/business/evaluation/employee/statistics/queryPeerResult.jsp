...
<script>
    ...
    $(document).ready(function () {
        taskResultTable = $("#taskResultTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getMonitoerPeerTask?evaluationType='+eType,
            },
            "destroy": true,
            "columns": [
                {
    ...
    function toEmps(id, taskName) {
        $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/resultPeer", {
            id: id,
            taskName: taskName,
    ...
    function look(id, taskName) {
        $("#right").load("<%=request.getContextPath()%>/evaluation/peerEcharts", {
            id: id,
            taskName: taskName,
            evaluationType:eType,
        });
    ...
    function search() {
        ...
        taskResultTable.ajax.url("<%=request.getContextPath()%>/evaluation/getMonitoerPeerTask"
