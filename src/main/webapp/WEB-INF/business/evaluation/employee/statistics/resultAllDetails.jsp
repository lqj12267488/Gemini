...
<script>
    ...
    function back() {
        if('0'== '${taskType}'){
            $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/monitorTeacherBySelf");
        }else if('1'== '${taskType}'){
            $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/monitorStudentBySelf");
        }else if('2'== '${taskType}'){
            $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/monitorParentBySelf");
        }else if('3'== '${taskType}'){
            $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/monitorLeaderBySelf");
        }else if('4'== '${taskType}'){
            $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/monitorPeerBySelf");
        }else{
