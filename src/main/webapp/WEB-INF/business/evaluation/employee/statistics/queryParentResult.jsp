...
<script>
    ...
    $(document).ready(function () {
        taskResultTable = $("#taskResultTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getMonitoerParentTask?evaluationType='+eType,
            },
            "destroy": true,
            "columns": [
                {
    ...
    function toEmps(id, taskName) {
        $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/resultParent", {
            id: id,
            taskName: taskName,
    ...
    function look(id, taskName) {
        $("#right").load("<%=request.getContextPath()%>/evaluation/parentEcharts", {
            id: id,
            taskName: taskName,
            evaluationType:eType,
        });
    ...
    function search() {
        ...
        taskResultTable.ajax.url("<%=request.getContextPath()%>/evaluation/getMonitoerParentTask"
