...
<script>
    ...
    $(document).ready(function () {
        taskResultTable = $("#taskResultTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getMonitoerStudentTask?evaluationType='+eType,
            },
            "destroy": true,
            "columns": [
                {
    ...
    function toEmps(id, taskName) {
        $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/resultStudent", {
            id: id,
            taskName: taskName,
    ...
    function look(id, taskName) {
        $("#right").load("<%=request.getContextPath()%>/evaluation/studentEcharts", {
            id: id,
            taskName: taskName,
            evaluationType:eType,
        });
    ...
    function search() {
        ...
        taskResultTable.ajax.url("<%=request.getContextPath()%>/evaluation/getMonitoerStudentTask"
