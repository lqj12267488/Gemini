...
<script>
    ...
    $(document).ready(function () {
        taskResultTable = $("#taskResultTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getMonitoerTask?evaluationType='+eType,
            },
            "destroy": true,
            "columns": [
    ...
    function toEmps(id, taskName) {
        $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/resultEmpsOrder", {
            id: id,
            taskName: taskName,
    ...
    function search() {
        ...
        taskResultTable.ajax.url("<%=request.getContextPath()%>/evaluation/getMonitoerTask"
