...
<script>
    ...
    function back() {
        if('0'== '${taskType}'){
            $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/orderTeacher");
        }else if('1'== '${taskType}'){
            $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/orderStudent");
        }else if('2'== '${taskType}'){
            $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/orderParent");
        }else if('3'== '${taskType}'){
            $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/orderLeader");
        }else if('4'== '${taskType}'){
            $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/orderPeer");
        }else{
