...
<script>
    ...
    $(document).ready(function () {
        taskTable = $("#taskTable").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/evaluation/getMonitoerTaskBySelf?evaluationType='+eType,
            },
            "destroy": true,
            "columns": [
    ...
    function toEmps(id, taskName) {
        ...
        $("#right").load("<%=request.getContextPath()%>/evaluation/statistics/detailsBySelf", {
            id: id,
            taskName: taskName,
    ...
    function search() {
        ...
        taskTable.ajax.url("<%=request.getContextPath()%>/evaluation/getMonitoerTaskBySelf"
