...
<script>
    ...
    $(document).ready(function () {
        empEvalTable = $("#empEvalTable").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/evaluation/result/getlisteStudentMenmbers?evaluationFlag=1&evaluationType='+eType
            },
            "destroy": true,
            "columns": [
    ...
    function search() {
        ...
        empEvalTable.ajax.url("<%=request.getContextPath()%>/evaluation/result/getlisteStudentMenmbers?"+
            "empPersonId="+empPersonId +"&" +
            "evaluationFlag=1" +"&" +
