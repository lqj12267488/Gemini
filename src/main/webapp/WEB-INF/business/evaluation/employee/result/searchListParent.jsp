...
<script>
    ...
    $(document).ready(function () {
        empEvalTable = $("#empEvalTable").DataTable({
            "ajax": {
                "type": "post",
                "url": '<%=request.getContextPath()%>/evaluation/result/getlisteParentMenmbers?evaluationFlag=1&evaluationType='+eType
            },
            "destroy": true,
            "columns": [
    ...
    function search() {
        ...
        empEvalTable.ajax.url("<%=request.getContextPath()%>/evaluation/result/getlisteParentMenmbers?"+
            "empPersonId="+empPersonId +"&" +
            "evaluationFlag=1" +"&" +
