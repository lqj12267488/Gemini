...
<script>
    ...
    $(document).ready(function () {
        $.get("<%=request.getContextPath()%>/evaluation/getEmpsTree?groupId=" + "${id}" + "&evaluationType=" + '${evaluationType}', function (data) {
    ...
    function save() {
        ...
        showSaveLoading();
        $.post("<%=request.getContextPath()%>/evaluation/saveGroupEmps", {
            groupId: $("#groupId").val(),
            ids: id,
