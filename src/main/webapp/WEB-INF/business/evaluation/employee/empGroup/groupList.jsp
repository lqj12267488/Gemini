...
//            'order': [1, 'desc'],
    ...
    function add() {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/toEmpGroupAdd");
        $("#dialog").modal("show");
    }

    function addEmps(id, eType) {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/toSelectEmp", {
            id: id,
            evaluationType: eType
        });
        $("#dialog").modal("show");
    ...
    function edit(id) {
        $("#dialog").load("<%=request.getContextPath()%>/evaluation/toEmpGroupEdit?id=" + id);
        $("#dialog").modal("show");
    }
</script>