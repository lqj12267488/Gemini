...
<script>
    ...
    $(document).ready(function () {
        table = $("#costItemTable").DataTable({
            "ajax": {
                //"url": '/payment/item/getCostItemList',
            ...
            "columns": [
                ...
                {"width":"50%","data": "dicname", "title": "缴费项目名称"},
                {
                    "width":"50%",
                    "title": "操作",
                    "render": function () {
        ...
        table.on('click', 'tr a', function () {
            ...
            var editUrl="/business/studentwork/payment/editPaymentItem";
            if (this.id == "editCost") {
            ...
            if (this.id == "delCost") {
                swal({
                    ...
                    $.post("<%=request.getContextPath()%>/payment/item/checkPaymentItem", {
                        itemId: diccode
                    }, function (msg) {
                        if(msg.status==1){
                            swal({
    ...
    function addCost() {
        var urlName="/business/studentwork/payment/addPaymentItem";
        $("#dialog").load("<%=request.getContextPath()%>/userDic/addUserDicSupplies?urlName=" + urlName);
        $("#dialog").modal("show");
        /*$("#dialog").load("/payment/item/toAdd")
        $("#dialog").modal("show")*/
    }
    ...
    function search() {
        ...
        if (cName != "") {
            ...
            //table.ajax.url("/payment/item/getCostItemList?costName="+cName).load();
