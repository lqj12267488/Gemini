    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="content">
                    <table id="newStudentPaymentTable" cellpadding="0" cellspacing="0" width="100%"
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $("#newStudentPaymentTable").DataTable({
            "ajax": {
    ...
    function setPaymentStandard(id) {
        $("#right").load("<%=request.getContextPath()%>/payment/newStudent/toNewStudentPaymentStandard?planId="+id);
    }
