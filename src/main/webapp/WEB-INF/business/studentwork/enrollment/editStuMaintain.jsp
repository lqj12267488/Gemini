    ...
    <div class="modal-content block-fill-white">
        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                ...
                <div class="form-row">
                    <div class="col-md-2 tar">
                        <span class="iconBtx">*</span> 运动服号
                    </div>
                    <div class="col-md-4">
                        <select id="clothes" class="js-example-basic-single"></select>
                    </div>
                    <div class="col-md-2 tar">
                        <span class="iconBtx">*</span> 是否特型
                    </div>
                    <div class="col-md-4">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=BDZT", function (data) {
            addOption(data, "reportStatus", $("#reportStatus").val());
        });
    ...
    function saveEnrollmentStudent() {
        ...
        var reportStatus = $("#reportStatus option:selected").val();
