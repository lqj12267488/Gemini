        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls">
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="studentNumber" type="text" value="${studentGrants.majorCode}" />
                    </div>
                    <div class="col-md-2 tar">
                        <span class="iconBtx">*</span>  就业形式
                    </div>
                    <div class="col-md-4">
                        <select id="employmentType"  onchange="hideOtherProperty()"></select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-2 tar">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <select readonly id="trainingLevelId" type="text" disabled="disabled" class="js-example-basic-single" ></select>
                    </div>
                    <div class="col-md-2 tar">
                        班级名称
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <select id="studentId"  type="text" disabled="disabled" class="js-example-basic-single" ></select>
                    </div>
                    <div class="col-md-2 tar">
                        性别
                    </div>
