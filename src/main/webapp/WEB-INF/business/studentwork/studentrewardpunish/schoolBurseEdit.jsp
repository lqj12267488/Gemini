...
<div class="modal-dialog">
        ...
        <div class="modal-body clearfix">
            ...
            <div class="controls" >
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="sex" type="text" value="${schoolBurse.sexShow}" key="${schoolBurse.sex}" readonly/>
                    </div>
                    <div class="col-md-2 tar">
                         身份证号
                    </div>
                    <div class="col-md-4">
                        <input id="idcard" type="text" value="${schoolBurse.idcard}" readonly/>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="burseSum" type="text" value="${schoolBurse.burseSum}"/>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <input id="grantUnit" type="text" value="${schoolBurse.grantUnit}"/>
                    </div>
                    <div class="col-md-2 tar">
    ...
    <input id="id" value="${schoolBurse.id}" type="hidden" >
    <input id="dept" value="${schoolBurse.departmentsId}" type="hidden" >
    <input id="major" value="${schoolBurse.majorShow}" type="hidden" >
    <input id="class" value="${schoolBurse.classId}" type="hidden" >
    <input id="student" value="${schoolBurse.studentId}" type="hidden" >
...
<script>
    ...
    $(document).ready(function (){
        $("#grantUnit").val("<%=CommonBean.getParamValue("SZXXMC")%>");
//系统字典项
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=XJXJCH", function (data) {
            addOption(data, 'title','${schoolBurse.title}');
        });
        $.get("<%=request.getContextPath()%>/common/getSysDict?name=XQ", function (data) {
            addOption(data, 'grantTime','${schoolBurse.grantTime}');
        });
        $.get("<%=request.getContextPath()%>/common/getSelectDept?type=8", function (data) {
            addOption(data, 'departmentsId','${schoolBurse.departmentsId}');
        });
//通过系部id获取专业-方向-层次下拉列表
        ...
        $.get("<%=request.getContextPath()%>/common/getMajorShowByDeptId?deptId="+$("#dept").val(),function (data) {
            addOption(data, "majorShow",'${schoolBurse.majorShow}');
        })
//通过专业-方向-层次id获取班级下拉列表
        ...
        $.get("<%=request.getContextPath()%>/common/getClassByMajorShow?majorShow="+$("#major").val(), function (data) {
            addOption(data, "classId", '${schoolBurse.classId}');
        })
//通过班级id获取学生下拉列表
        ...
        $.get("<%=request.getContextPath()%>/common/getStudentByClassId?classId="+$("#class").val(), function (data) {
            addOption(data, "studentId",'${schoolBurse.studentId}');
        })
//通过学生获取性别和身份证号
...
//查看详情设置控件只读
    ...
    function save() {
        ...
        var grantTime=$("#grantTime").val();
        grantTime=grantTime.replace("T","");
        showSaveLoading();
        $.post("<%=request.getContextPath()%>/studentRewardPunish/schoolBurse/save", {
            id:$("#id").val(),
