        ...
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="block block-drop-shadow content">
                    ...
                    <table id="backTable" cellpadding="0" cellspacing="0" width="100%"
                           class="table table-bordered table-striped sortable_default">
                        <thead>
                        <tr>
                            <th width="8%"><input type="checkbox" id="checkAll" onclick="checkAll()"/>
                            </th>
                            <th>id</th>
                            <th>departmentsId</th>
                            <th>majorCode</th>
    ...
    function backDorm() {
        ...
        var check_value = "";
         if($('input[name="checkbox"]:checked').length==0) {
            ...
            $("#dialog").load("<%=request.getContextPath()%>/dorm/toBackDorm?ids="+ids+"&check_value="+check_value);
            $("#dialog").modal("show");
        }
