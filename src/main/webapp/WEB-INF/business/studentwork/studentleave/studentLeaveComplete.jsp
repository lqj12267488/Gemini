...
<script>
    ...
    $(document).ready(function () {
        ...
        roleTable = $("#leaveGrid").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/studentLeave/getCompleteList',
            },
            "destroy": true,
            "columns": [
                {"data": "id", "visible": false},
                {"data": "createTime", "visible": false},
                {"width": "10%","data": "requestDept", "title": "代申请部门"},
                {"width": "10%","data": "requester", "title": "代申请人"},
                {"width": "12%","data": "studentName", "title": "学生姓名"},
        ...
        roleTable.on('click', 'tr a', function () {
            ...
            if (this.id == "handleFlowTtrack") {
                $("#right").load("<%=request.getContextPath()%>/getWotkflowLog", {
                    ...
                    url: "<%=request.getContextPath()%>/studentLeave/auditStudentLeaveById?id=" + leaveProcessId,
                    backUrl: "/studentLeave/complete"
                });
            }
        });
    });
