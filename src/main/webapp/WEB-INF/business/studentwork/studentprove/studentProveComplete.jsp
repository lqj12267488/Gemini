...
<script>
    ...
    $(document).ready(function () {
        ...
        roleTable = $("#studentProveGrid").DataTable({
            "ajax": {
                "url": '<%=request.getContextPath()%>/studentProve/getCompleteList',
            },
            "destroy": true,
            "columns": [
        ...
        roleTable.on('click', 'tr a', function () {
            ...
            if (this.id == "handleFlowTtrack") {
                $("#right").load("<%=request.getContextPath()%>/getWotkflowLog", {
                    ...
                    url: "<%=request.getContextPath()%>/studentProve/auditStudentProveById?id=" + studentProveProcessId,
                    backUrl: "/studentProve/complete"
                });
            }
        });
    });
