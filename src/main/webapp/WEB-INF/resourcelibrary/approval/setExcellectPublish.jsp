...
<div class="modal-dialog">
    <div class="modal-content block-fill-white">
        <div class="modal-header">
            ...
            <input id="jpkId" hidden value="${data.resourceId}"/>
        </div>
        <div class="modal-body clearfix">
            <div class="controls">
                <div class="form-row">
                    ...
                    <div class="col-md-9">
                        <input id="resourceName" onchange="changeData()" value="${data.resourceName}" disabled/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <select id="resourceSubjectIdd" onchange="changeData()" disabled/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <select id="resourceMajorIdd" onchange="changeMajor()" disabled/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
                    ...
                    <div class="col-md-9">
                        <select id="resourceCourseIdd" disabled/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 tar">
...
<script>
    ...
    function save() {
        ...
        if (jpkTypeName == "" || jpkTypeName == undefined || jpkTypeName == null) {
            swal({title: "请填写精品课类型！",type: "info"});
            return;
        }
        $.post("<%=request.getContextPath()%>/resourceLibrary/saveExcellect", {
            resourceId:jpkId,
