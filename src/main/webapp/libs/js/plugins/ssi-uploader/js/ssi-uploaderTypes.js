...
(function (root, factory) {
    ...
    Ssi_upload.prototype.init = function (element) {
        ...
        this.$element.append($('<div class="ssi-buttonWrapper">').append($abortBtn, $uploadBtn, $clearBtn));
...
//----------------------------UPLOADFILES------------------------------------
    ...
    var locale = {
        en: {
            ...
            clear: '清空',
            drag: '请将文件拖拽到此处',
            sizeError: '$1 文件大小不能大于 $2',// $1=file name ,$2=max ie( example.jpg has has exceed the size limit of 2mb)
            extError: '不能上传$1文件！',//$1=file extension ie(exe files are not supported)
            someErrorsOccurred: '服务器出错！'
        },
        gr: {
            success: 'Επιτυχία',
